...
export class Scalar implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::bls12381::Scalar`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Scalar.$typeName; readonly $fullTypeName: `0x2::bls12381::Scalar`; readonly $typeArgs: []; readonly $isPhantom = Scalar.$isPhantom;
 ...
 static reified( ): ScalarReified { const reifiedBcs = Scalar.bcs; return { typeName: Scalar.$typeName, fullTypeName: composeSuiType( Scalar.$typeName, ...[] ) as `0x2::bls12381::Scalar`, typeArgs: [ ] as [], isPhantom: Scalar.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Scalar.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Scalar.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Scalar.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Scalar.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Scalar.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Scalar.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Scalar.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Scalar.fetch( client, id, ), new: ( fields: ScalarFields, ) => { return new Scalar( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Scalar", {
 ...
 static get bcs(): ReturnType<typeof Scalar.instantiateBcs> { if (!Scalar.cachedBcs) { Scalar.cachedBcs = Scalar.instantiateBcs() } return Scalar.cachedBcs };
...
export class G1 implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::bls12381::G1`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = G1.$typeName; readonly $fullTypeName: `0x2::bls12381::G1`; readonly $typeArgs: []; readonly $isPhantom = G1.$isPhantom;
 ...
 private static instantiateBcs() { return bcs.struct("G1", {
 ...
 static get bcs(): ReturnType<typeof G1.instantiateBcs> { if (!G1.cachedBcs) { G1.cachedBcs = G1.instantiateBcs() } return G1.cachedBcs };
...
export class G2 implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::bls12381::G2`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = G2.$typeName; readonly $fullTypeName: `0x2::bls12381::G2`; readonly $typeArgs: []; readonly $isPhantom = G2.$isPhantom;
 ...
 static reified( ): G2Reified { const reifiedBcs = G2.bcs; return { typeName: G2.$typeName, fullTypeName: composeSuiType( G2.$typeName, ...[] ) as `0x2::bls12381::G2`, typeArgs: [ ] as [], isPhantom: G2.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => G2.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => G2.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => G2.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => G2.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => G2.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => G2.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => G2.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => G2.fetch( client, id, ), new: ( fields: G2Fields, ) => { return new G2( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("G2", {
 ...
 static get bcs(): ReturnType<typeof G2.instantiateBcs> { if (!G2.cachedBcs) { G2.cachedBcs = G2.instantiateBcs() } return G2.cachedBcs };
...
export class GT implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::bls12381::GT`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = GT.$typeName; readonly $fullTypeName: `0x2::bls12381::GT`; readonly $typeArgs: []; readonly $isPhantom = GT.$isPhantom;
 ...
 static reified( ): GTReified { const reifiedBcs = GT.bcs; return { typeName: GT.$typeName, fullTypeName: composeSuiType( GT.$typeName, ...[] ) as `0x2::bls12381::GT`, typeArgs: [ ] as [], isPhantom: GT.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => GT.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => GT.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => GT.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => GT.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => GT.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => GT.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => GT.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => GT.fetch( client, id, ), new: ( fields: GTFields, ) => { return new GT( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("GT", {
 ...
 static get bcs(): ReturnType<typeof GT.instantiateBcs> { if (!GT.cachedBcs) { GT.cachedBcs = GT.instantiateBcs() } return GT.cachedBcs };
...
export function isUncompressedG1(type: string): boolean { type = compressSuiType(type); return type === `0x2::bls12381::UncompressedG1`; }
...
export class UncompressedG1 implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::bls12381::UncompressedG1`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UncompressedG1.$typeName; readonly $fullTypeName: `0x2::bls12381::UncompressedG1`; readonly $typeArgs: []; readonly $isPhantom = UncompressedG1.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: UncompressedG1Fields, ) { this.$fullTypeName = composeSuiType( UncompressedG1.$typeName, ...typeArgs ) as `0x2::bls12381::UncompressedG1`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): UncompressedG1Reified { const reifiedBcs = UncompressedG1.bcs; return { typeName: UncompressedG1.$typeName, fullTypeName: composeSuiType( UncompressedG1.$typeName, ...[] ) as `0x2::bls12381::UncompressedG1`, typeArgs: [ ] as [], isPhantom: UncompressedG1.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UncompressedG1.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UncompressedG1.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UncompressedG1.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => UncompressedG1.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UncompressedG1.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UncompressedG1.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UncompressedG1.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UncompressedG1.fetch( client, id, ), new: ( fields: UncompressedG1Fields, ) => { return new UncompressedG1( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("UncompressedG1", {
 ...
 static get bcs(): ReturnType<typeof UncompressedG1.instantiateBcs> { if (!UncompressedG1.cachedBcs) { UncompressedG1.cachedBcs = UncompressedG1.instantiateBcs() } return UncompressedG1.cachedBcs };
