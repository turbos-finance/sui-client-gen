...
export class LinkedTable<K extends TypeArgument, V extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::linked_table::LinkedTable`; static readonly $numTypeParams = 2; static readonly $isPhantom = [false,true,] as const;

 readonly $typeName = LinkedTable.$typeName; readonly $fullTypeName: `0x2::linked_table::LinkedTable<${ToTypeStr<K>}, ${PhantomToTypeStr<V>}>`; readonly $typeArgs: [ToTypeStr<K>, PhantomToTypeStr<V>]; readonly $isPhantom = LinkedTable.$isPhantom;
 ...
 static reified<K extends Reified<TypeArgument, any>, V extends PhantomReified<PhantomTypeArgument>>( K: K, V: V ): LinkedTableReified<ToTypeArgument<K>, ToPhantomTypeArgument<V>> { const reifiedBcs = LinkedTable.bcs(toBcs(K)); return { typeName: LinkedTable.$typeName, fullTypeName: composeSuiType( LinkedTable.$typeName, ...[extractType(K), extractType(V)] ) as `0x2::linked_table::LinkedTable<${ToTypeStr<ToTypeArgument<K>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<V>>}>`, typeArgs: [ extractType(K), extractType(V) ] as [ToTypeStr<ToTypeArgument<K>>, PhantomToTypeStr<ToPhantomTypeArgument<V>>], isPhantom: LinkedTable.$isPhantom, reifiedTypeArgs: [K, V], fromFields: (fields: Record<string, any>) => LinkedTable.fromFields( [K, V], fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => LinkedTable.fromFieldsWithTypes( [K, V], item, ), fromBcs: (data: Uint8Array) => LinkedTable.fromFields( [K, V], reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => LinkedTable.fromJSONField( [K, V], field, ), fromJSON: (json: Record<string, any>) => LinkedTable.fromJSON( [K, V], json, ), fromSuiParsedData: (content: SuiParsedData) => LinkedTable.fromSuiParsedData( [K, V], content, ), fromSuiObjectData: (content: SuiObjectData) => LinkedTable.fromSuiObjectData( [K, V], content, ), fetch: async (client: SuiClient, id: string) => LinkedTable.fetch( client, [K, V], id, ), new: ( fields: LinkedTableFields<ToTypeArgument<K>, ToPhantomTypeArgument<V>>, ) => { return new LinkedTable( [extractType(K), extractType(V)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return <K extends BcsType<any>>(K: K) => bcs.struct(`LinkedTable<${K.name}>`, {
 ...
 static get bcs(): ReturnType<typeof LinkedTable.instantiateBcs> { if (!LinkedTable.cachedBcs) { LinkedTable.cachedBcs = LinkedTable.instantiateBcs() } return LinkedTable.cachedBcs };
...
export class Node<K extends TypeArgument, V extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::linked_table::Node`; static readonly $numTypeParams = 2; static readonly $isPhantom = [false,false,] as const;

 readonly $typeName = Node.$typeName; readonly $fullTypeName: `0x2::linked_table::Node<${ToTypeStr<K>}, ${ToTypeStr<V>}>`; readonly $typeArgs: [ToTypeStr<K>, ToTypeStr<V>]; readonly $isPhantom = Node.$isPhantom;
 ...
 static reified<K extends Reified<TypeArgument, any>, V extends Reified<TypeArgument, any>>( K: K, V: V ): NodeReified<ToTypeArgument<K>, ToTypeArgument<V>> { const reifiedBcs = Node.bcs(toBcs(K), toBcs(V)); return { typeName: Node.$typeName, fullTypeName: composeSuiType( Node.$typeName, ...[extractType(K), extractType(V)] ) as `0x2::linked_table::Node<${ToTypeStr<ToTypeArgument<K>>}, ${ToTypeStr<ToTypeArgument<V>>}>`, typeArgs: [ extractType(K), extractType(V) ] as [ToTypeStr<ToTypeArgument<K>>, ToTypeStr<ToTypeArgument<V>>], isPhantom: Node.$isPhantom, reifiedTypeArgs: [K, V], fromFields: (fields: Record<string, any>) => Node.fromFields( [K, V], fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Node.fromFieldsWithTypes( [K, V], item, ), fromBcs: (data: Uint8Array) => Node.fromFields( [K, V], reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Node.fromJSONField( [K, V], field, ), fromJSON: (json: Record<string, any>) => Node.fromJSON( [K, V], json, ), fromSuiParsedData: (content: SuiParsedData) => Node.fromSuiParsedData( [K, V], content, ), fromSuiObjectData: (content: SuiObjectData) => Node.fromSuiObjectData( [K, V], content, ), fetch: async (client: SuiClient, id: string) => Node.fetch( client, [K, V], id, ), new: ( fields: NodeFields<ToTypeArgument<K>, ToTypeArgument<V>>, ) => { return new Node( [extractType(K), extractType(V)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return <K extends BcsType<any>, V extends BcsType<any>>(K: K, V: V) => bcs.struct(`Node<${K.name}, ${V.name}>`, {
 ...
 static get bcs(): ReturnType<typeof Node.instantiateBcs> { if (!Node.cachedBcs) { Node.cachedBcs = Node.instantiateBcs() } return Node.cachedBcs };
