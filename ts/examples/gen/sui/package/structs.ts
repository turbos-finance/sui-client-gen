...
export class Publisher implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::package::Publisher`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Publisher.$typeName; readonly $fullTypeName: `0x2::package::Publisher`; readonly $typeArgs: []; readonly $isPhantom = Publisher.$isPhantom;
 ...
 static reified( ): PublisherReified { const reifiedBcs = Publisher.bcs; return { typeName: Publisher.$typeName, fullTypeName: composeSuiType( Publisher.$typeName, ...[] ) as `0x2::package::Publisher`, typeArgs: [ ] as [], isPhantom: Publisher.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Publisher.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Publisher.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Publisher.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Publisher.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Publisher.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Publisher.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Publisher.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Publisher.fetch( client, id, ), new: ( fields: PublisherFields, ) => { return new Publisher( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Publisher", {
 ...
 static get bcs(): ReturnType<typeof Publisher.instantiateBcs> { if (!Publisher.cachedBcs) { Publisher.cachedBcs = Publisher.instantiateBcs() } return Publisher.cachedBcs };
...
export class UpgradeCap implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::package::UpgradeCap`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UpgradeCap.$typeName; readonly $fullTypeName: `0x2::package::UpgradeCap`; readonly $typeArgs: []; readonly $isPhantom = UpgradeCap.$isPhantom;
 ...
 static reified( ): UpgradeCapReified { const reifiedBcs = UpgradeCap.bcs; return { typeName: UpgradeCap.$typeName, fullTypeName: composeSuiType( UpgradeCap.$typeName, ...[] ) as `0x2::package::UpgradeCap`, typeArgs: [ ] as [], isPhantom: UpgradeCap.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UpgradeCap.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UpgradeCap.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UpgradeCap.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => UpgradeCap.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UpgradeCap.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UpgradeCap.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UpgradeCap.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UpgradeCap.fetch( client, id, ), new: ( fields: UpgradeCapFields, ) => { return new UpgradeCap( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("UpgradeCap", {
 ...
 static get bcs(): ReturnType<typeof UpgradeCap.instantiateBcs> { if (!UpgradeCap.cachedBcs) { UpgradeCap.cachedBcs = UpgradeCap.instantiateBcs() } return UpgradeCap.cachedBcs };
...
export class UpgradeTicket implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::package::UpgradeTicket`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UpgradeTicket.$typeName; readonly $fullTypeName: `0x2::package::UpgradeTicket`; readonly $typeArgs: []; readonly $isPhantom = UpgradeTicket.$isPhantom;
 ...
 static reified( ): UpgradeTicketReified { const reifiedBcs = UpgradeTicket.bcs; return { typeName: UpgradeTicket.$typeName, fullTypeName: composeSuiType( UpgradeTicket.$typeName, ...[] ) as `0x2::package::UpgradeTicket`, typeArgs: [ ] as [], isPhantom: UpgradeTicket.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UpgradeTicket.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UpgradeTicket.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UpgradeTicket.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => UpgradeTicket.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UpgradeTicket.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UpgradeTicket.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UpgradeTicket.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UpgradeTicket.fetch( client, id, ), new: ( fields: UpgradeTicketFields, ) => { return new UpgradeTicket( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("UpgradeTicket", {
 ...
 static get bcs(): ReturnType<typeof UpgradeTicket.instantiateBcs> { if (!UpgradeTicket.cachedBcs) { UpgradeTicket.cachedBcs = UpgradeTicket.instantiateBcs() } return UpgradeTicket.cachedBcs };
...
export class UpgradeReceipt implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::package::UpgradeReceipt`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UpgradeReceipt.$typeName; readonly $fullTypeName: `0x2::package::UpgradeReceipt`; readonly $typeArgs: []; readonly $isPhantom = UpgradeReceipt.$isPhantom;
 ...
 static reified( ): UpgradeReceiptReified { const reifiedBcs = UpgradeReceipt.bcs; return { typeName: UpgradeReceipt.$typeName, fullTypeName: composeSuiType( UpgradeReceipt.$typeName, ...[] ) as `0x2::package::UpgradeReceipt`, typeArgs: [ ] as [], isPhantom: UpgradeReceipt.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UpgradeReceipt.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UpgradeReceipt.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UpgradeReceipt.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => UpgradeReceipt.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UpgradeReceipt.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UpgradeReceipt.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UpgradeReceipt.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UpgradeReceipt.fetch( client, id, ), new: ( fields: UpgradeReceiptFields, ) => { return new UpgradeReceipt( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("UpgradeReceipt", {
 ...
 static get bcs(): ReturnType<typeof UpgradeReceipt.instantiateBcs> { if (!UpgradeReceipt.cachedBcs) { UpgradeReceipt.cachedBcs = UpgradeReceipt.instantiateBcs() } return UpgradeReceipt.cachedBcs };
