...
export class Extension implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::kiosk_extension::Extension`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Extension.$typeName; readonly $fullTypeName: `0x2::kiosk_extension::Extension`; readonly $typeArgs: []; readonly $isPhantom = Extension.$isPhantom;
 ...
 static reified( ): ExtensionReified { const reifiedBcs = Extension.bcs; return { typeName: Extension.$typeName, fullTypeName: composeSuiType( Extension.$typeName, ...[] ) as `0x2::kiosk_extension::Extension`, typeArgs: [ ] as [], isPhantom: Extension.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Extension.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Extension.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Extension.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Extension.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Extension.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Extension.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Extension.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Extension.fetch( client, id, ), new: ( fields: ExtensionFields, ) => { return new Extension( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Extension", {
 ...
 static get bcs(): ReturnType<typeof Extension.instantiateBcs> { if (!Extension.cachedBcs) { Extension.cachedBcs = Extension.instantiateBcs() } return Extension.cachedBcs };
...
export class ExtensionKey<Ext extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::kiosk_extension::ExtensionKey`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = ExtensionKey.$typeName; readonly $fullTypeName: `0x2::kiosk_extension::ExtensionKey<${PhantomToTypeStr<Ext>}>`; readonly $typeArgs: [PhantomToTypeStr<Ext>]; readonly $isPhantom = ExtensionKey.$isPhantom;
 ...
 static reified<Ext extends PhantomReified<PhantomTypeArgument>>( Ext: Ext ): ExtensionKeyReified<ToPhantomTypeArgument<Ext>> { const reifiedBcs = ExtensionKey.bcs; return { typeName: ExtensionKey.$typeName, fullTypeName: composeSuiType( ExtensionKey.$typeName, ...[extractType(Ext)] ) as `0x2::kiosk_extension::ExtensionKey<${PhantomToTypeStr<ToPhantomTypeArgument<Ext>>}>`, typeArgs: [ extractType(Ext) ] as [PhantomToTypeStr<ToPhantomTypeArgument<Ext>>], isPhantom: ExtensionKey.$isPhantom, reifiedTypeArgs: [Ext], fromFields: (fields: Record<string, any>) => ExtensionKey.fromFields( Ext, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ExtensionKey.fromFieldsWithTypes( Ext, item, ), fromBcs: (data: Uint8Array) => ExtensionKey.fromFields( Ext, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => ExtensionKey.fromJSONField( Ext, field, ), fromJSON: (json: Record<string, any>) => ExtensionKey.fromJSON( Ext, json, ), fromSuiParsedData: (content: SuiParsedData) => ExtensionKey.fromSuiParsedData( Ext, content, ), fromSuiObjectData: (content: SuiObjectData) => ExtensionKey.fromSuiObjectData( Ext, content, ), fetch: async (client: SuiClient, id: string) => ExtensionKey.fetch( client, Ext, id, ), new: ( fields: ExtensionKeyFields<ToPhantomTypeArgument<Ext>>, ) => { return new ExtensionKey( [extractType(Ext)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("ExtensionKey", {
 ...
 static get bcs(): ReturnType<typeof ExtensionKey.instantiateBcs> { if (!ExtensionKey.cachedBcs) { ExtensionKey.cachedBcs = ExtensionKey.instantiateBcs() } return ExtensionKey.cachedBcs };
