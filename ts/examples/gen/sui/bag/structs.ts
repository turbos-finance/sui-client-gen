...
export class Bag implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::bag::Bag`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Bag.$typeName; readonly $fullTypeName: `0x2::bag::Bag`; readonly $typeArgs: []; readonly $isPhantom = Bag.$isPhantom;
 ...
 static reified( ): BagReified { const reifiedBcs = Bag.bcs; return { typeName: Bag.$typeName, fullTypeName: composeSuiType( Bag.$typeName, ...[] ) as `0x2::bag::Bag`, typeArgs: [ ] as [], isPhantom: Bag.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Bag.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Bag.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Bag.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Bag.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Bag.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Bag.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Bag.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Bag.fetch( client, id, ), new: ( fields: BagFields, ) => { return new Bag( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Bag", {
 ...
 static get bcs(): ReturnType<typeof Bag.instantiateBcs> { if (!Bag.cachedBcs) { Bag.cachedBcs = Bag.instantiateBcs() } return Bag.cachedBcs };
