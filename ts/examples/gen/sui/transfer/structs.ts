...
export class Receiving<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::transfer::Receiving`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = Receiving.$typeName; readonly $fullTypeName: `0x2::transfer::Receiving<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = Receiving.$isPhantom;
 ...
 private static instantiateBcs() { return bcs.struct("Receiving", {
 ...
 static get bcs(): ReturnType<typeof Receiving.instantiateBcs> { if (!Receiving.cachedBcs) { Receiving.cachedBcs = Receiving.instantiateBcs() } return Receiving.cachedBcs };
