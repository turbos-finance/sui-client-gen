...
export class OwnerKey implements StructClass { __StructClass = true as const;
 ...
 static get bcs(): ReturnType<typeof OwnerKey.instantiateBcs> { if (!OwnerKey.cachedBcs) { OwnerKey.cachedBcs = OwnerKey.instantiateBcs() } return OwnerKey.cachedBcs };
...
export class Owner implements StructClass { __StructClass = true as const;
 ...
 static get bcs(): ReturnType<typeof Owner.instantiateBcs> { if (!Owner.cachedBcs) { Owner.cachedBcs = Owner.instantiateBcs() } return Owner.cachedBcs };
...
export class MetadataKey<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs(): ReturnType<typeof MetadataKey.instantiateBcs> { if (!MetadataKey.cachedBcs) { MetadataKey.cachedBcs = MetadataKey.instantiateBcs() } return MetadataKey.cachedBcs };
...
export class Metadata<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static get bcs(): ReturnType<typeof Metadata.instantiateBcs> { if (!Metadata.cachedBcs) { Metadata.cachedBcs = Metadata.instantiateBcs() } return Metadata.cachedBcs };
