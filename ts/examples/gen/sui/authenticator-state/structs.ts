...
export class AuthenticatorState implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::authenticator_state::AuthenticatorState`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = AuthenticatorState.$typeName; readonly $fullTypeName: `0x2::authenticator_state::AuthenticatorState`; readonly $typeArgs: []; readonly $isPhantom = AuthenticatorState.$isPhantom;
 ...
 static reified( ): AuthenticatorStateReified { const reifiedBcs = AuthenticatorState.bcs; return { typeName: AuthenticatorState.$typeName, fullTypeName: composeSuiType( AuthenticatorState.$typeName, ...[] ) as `0x2::authenticator_state::AuthenticatorState`, typeArgs: [ ] as [], isPhantom: AuthenticatorState.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => AuthenticatorState.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => AuthenticatorState.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => AuthenticatorState.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => AuthenticatorState.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => AuthenticatorState.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => AuthenticatorState.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => AuthenticatorState.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => AuthenticatorState.fetch( client, id, ), new: ( fields: AuthenticatorStateFields, ) => { return new AuthenticatorState( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("AuthenticatorState", {
 ...
 static get bcs(): ReturnType<typeof AuthenticatorState.instantiateBcs> { if (!AuthenticatorState.cachedBcs) { AuthenticatorState.cachedBcs = AuthenticatorState.instantiateBcs() } return AuthenticatorState.cachedBcs };
...
export class AuthenticatorStateInner implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::authenticator_state::AuthenticatorStateInner`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = AuthenticatorStateInner.$typeName; readonly $fullTypeName: `0x2::authenticator_state::AuthenticatorStateInner`; readonly $typeArgs: []; readonly $isPhantom = AuthenticatorStateInner.$isPhantom;
 ...
 static reified( ): AuthenticatorStateInnerReified { const reifiedBcs = AuthenticatorStateInner.bcs; return { typeName: AuthenticatorStateInner.$typeName, fullTypeName: composeSuiType( AuthenticatorStateInner.$typeName, ...[] ) as `0x2::authenticator_state::AuthenticatorStateInner`, typeArgs: [ ] as [], isPhantom: AuthenticatorStateInner.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => AuthenticatorStateInner.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => AuthenticatorStateInner.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => AuthenticatorStateInner.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => AuthenticatorStateInner.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => AuthenticatorStateInner.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => AuthenticatorStateInner.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => AuthenticatorStateInner.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => AuthenticatorStateInner.fetch( client, id, ), new: ( fields: AuthenticatorStateInnerFields, ) => { return new AuthenticatorStateInner( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("AuthenticatorStateInner", {
 ...
 static get bcs(): ReturnType<typeof AuthenticatorStateInner.instantiateBcs> { if (!AuthenticatorStateInner.cachedBcs) { AuthenticatorStateInner.cachedBcs = AuthenticatorStateInner.instantiateBcs() } return AuthenticatorStateInner.cachedBcs };
...
export class JWK implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::authenticator_state::JWK`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = JWK.$typeName; readonly $fullTypeName: `0x2::authenticator_state::JWK`; readonly $typeArgs: []; readonly $isPhantom = JWK.$isPhantom;
 ...
 static reified( ): JWKReified { const reifiedBcs = JWK.bcs; return { typeName: JWK.$typeName, fullTypeName: composeSuiType( JWK.$typeName, ...[] ) as `0x2::authenticator_state::JWK`, typeArgs: [ ] as [], isPhantom: JWK.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => JWK.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => JWK.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => JWK.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => JWK.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => JWK.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => JWK.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => JWK.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => JWK.fetch( client, id, ), new: ( fields: JWKFields, ) => { return new JWK( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("JWK", {
 ...
 static get bcs(): ReturnType<typeof JWK.instantiateBcs> { if (!JWK.cachedBcs) { JWK.cachedBcs = JWK.instantiateBcs() } return JWK.cachedBcs };
...
export class JwkId implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::authenticator_state::JwkId`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = JwkId.$typeName; readonly $fullTypeName: `0x2::authenticator_state::JwkId`; readonly $typeArgs: []; readonly $isPhantom = JwkId.$isPhantom;
 ...
 static reified( ): JwkIdReified { const reifiedBcs = JwkId.bcs; return { typeName: JwkId.$typeName, fullTypeName: composeSuiType( JwkId.$typeName, ...[] ) as `0x2::authenticator_state::JwkId`, typeArgs: [ ] as [], isPhantom: JwkId.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => JwkId.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => JwkId.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => JwkId.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => JwkId.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => JwkId.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => JwkId.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => JwkId.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => JwkId.fetch( client, id, ), new: ( fields: JwkIdFields, ) => { return new JwkId( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("JwkId", {
 ...
 static get bcs(): ReturnType<typeof JwkId.instantiateBcs> { if (!JwkId.cachedBcs) { JwkId.cachedBcs = JwkId.instantiateBcs() } return JwkId.cachedBcs };
...
export class ActiveJwk implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::authenticator_state::ActiveJwk`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ActiveJwk.$typeName; readonly $fullTypeName: `0x2::authenticator_state::ActiveJwk`; readonly $typeArgs: []; readonly $isPhantom = ActiveJwk.$isPhantom;
 ...
 static reified( ): ActiveJwkReified { const reifiedBcs = ActiveJwk.bcs; return { typeName: ActiveJwk.$typeName, fullTypeName: composeSuiType( ActiveJwk.$typeName, ...[] ) as `0x2::authenticator_state::ActiveJwk`, typeArgs: [ ] as [], isPhantom: ActiveJwk.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ActiveJwk.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ActiveJwk.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ActiveJwk.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => ActiveJwk.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ActiveJwk.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ActiveJwk.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => ActiveJwk.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => ActiveJwk.fetch( client, id, ), new: ( fields: ActiveJwkFields, ) => { return new ActiveJwk( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("ActiveJwk", {
 ...
 static get bcs(): ReturnType<typeof ActiveJwk.instantiateBcs> { if (!ActiveJwk.cachedBcs) { ActiveJwk.cachedBcs = ActiveJwk.instantiateBcs() } return ActiveJwk.cachedBcs };
