...
export class Coin<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::coin::Coin`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = Coin.$typeName; readonly $fullTypeName: `0x2::coin::Coin<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = Coin.$isPhantom;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): CoinReified<ToPhantomTypeArgument<T>> { const reifiedBcs = Coin.bcs; return { typeName: Coin.$typeName, fullTypeName: composeSuiType( Coin.$typeName, ...[extractType(T)] ) as `0x2::coin::Coin<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: Coin.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => Coin.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Coin.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => Coin.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Coin.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => Coin.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => Coin.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => Coin.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => Coin.fetch( client, T, id, ), new: ( fields: CoinFields<ToPhantomTypeArgument<T>>, ) => { return new Coin( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Coin", {
 ...
 static get bcs(): ReturnType<typeof Coin.instantiateBcs> { if (!Coin.cachedBcs) { Coin.cachedBcs = Coin.instantiateBcs() } return Coin.cachedBcs };
...
export class CoinMetadata<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::coin::CoinMetadata`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = CoinMetadata.$typeName; readonly $fullTypeName: `0x2::coin::CoinMetadata<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = CoinMetadata.$isPhantom;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): CoinMetadataReified<ToPhantomTypeArgument<T>> { const reifiedBcs = CoinMetadata.bcs; return { typeName: CoinMetadata.$typeName, fullTypeName: composeSuiType( CoinMetadata.$typeName, ...[extractType(T)] ) as `0x2::coin::CoinMetadata<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: CoinMetadata.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => CoinMetadata.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => CoinMetadata.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => CoinMetadata.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => CoinMetadata.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => CoinMetadata.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => CoinMetadata.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => CoinMetadata.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => CoinMetadata.fetch( client, T, id, ), new: ( fields: CoinMetadataFields<ToPhantomTypeArgument<T>>, ) => { return new CoinMetadata( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("CoinMetadata", {
 ...
 static get bcs(): ReturnType<typeof CoinMetadata.instantiateBcs> { if (!CoinMetadata.cachedBcs) { CoinMetadata.cachedBcs = CoinMetadata.instantiateBcs() } return CoinMetadata.cachedBcs };
...
export class RegulatedCoinMetadata<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::coin::RegulatedCoinMetadata`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = RegulatedCoinMetadata.$typeName; readonly $fullTypeName: `0x2::coin::RegulatedCoinMetadata<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = RegulatedCoinMetadata.$isPhantom;
 ...
 private static instantiateBcs() { return bcs.struct("RegulatedCoinMetadata", {
 ...
 static get bcs(): ReturnType<typeof RegulatedCoinMetadata.instantiateBcs> { if (!RegulatedCoinMetadata.cachedBcs) { RegulatedCoinMetadata.cachedBcs = RegulatedCoinMetadata.instantiateBcs() } return RegulatedCoinMetadata.cachedBcs };
...
export class TreasuryCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::coin::TreasuryCap`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TreasuryCap.$typeName; readonly $fullTypeName: `0x2::coin::TreasuryCap<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TreasuryCap.$isPhantom;
 ...
 private static instantiateBcs() { return bcs.struct("TreasuryCap", {
 ...
 static get bcs(): ReturnType<typeof TreasuryCap.instantiateBcs> { if (!TreasuryCap.cachedBcs) { TreasuryCap.cachedBcs = TreasuryCap.instantiateBcs() } return TreasuryCap.cachedBcs };
...
export function isDenyCapV2(type: string): boolean { type = compressSuiType(type); return type.startsWith(`0x2::coin::DenyCapV2` + '<'); }
...
export class DenyCapV2<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::coin::DenyCapV2`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = DenyCapV2.$typeName; readonly $fullTypeName: `0x2::coin::DenyCapV2<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = DenyCapV2.$isPhantom;

 readonly id: ToField<UID>; readonly allowGlobalPause: ToField<"bool">

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: DenyCapV2Fields<T>, ) { this.$fullTypeName = composeSuiType( DenyCapV2.$typeName, ...typeArgs ) as `0x2::coin::DenyCapV2<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.allowGlobalPause = fields.allowGlobalPause; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): DenyCapV2Reified<ToPhantomTypeArgument<T>> { const reifiedBcs = DenyCapV2.bcs; return { typeName: DenyCapV2.$typeName, fullTypeName: composeSuiType( DenyCapV2.$typeName, ...[extractType(T)] ) as `0x2::coin::DenyCapV2<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: DenyCapV2.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => DenyCapV2.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DenyCapV2.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => DenyCapV2.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => DenyCapV2.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => DenyCapV2.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => DenyCapV2.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => DenyCapV2.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => DenyCapV2.fetch( client, T, id, ), new: ( fields: DenyCapV2Fields<ToPhantomTypeArgument<T>>, ) => { return new DenyCapV2( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("DenyCapV2", {
 ...
 static get bcs(): ReturnType<typeof DenyCapV2.instantiateBcs> { if (!DenyCapV2.cachedBcs) { DenyCapV2.cachedBcs = DenyCapV2.instantiateBcs() } return DenyCapV2.cachedBcs };
...
export class CurrencyCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::coin::CurrencyCreated`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = CurrencyCreated.$typeName; readonly $fullTypeName: `0x2::coin::CurrencyCreated<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = CurrencyCreated.$isPhantom;
 ...
 private static instantiateBcs() { return bcs.struct("CurrencyCreated", {
 ...
 static get bcs(): ReturnType<typeof CurrencyCreated.instantiateBcs> { if (!CurrencyCreated.cachedBcs) { CurrencyCreated.cachedBcs = CurrencyCreated.instantiateBcs() } return CurrencyCreated.cachedBcs };
...
export class DenyCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::coin::DenyCap`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = DenyCap.$typeName; readonly $fullTypeName: `0x2::coin::DenyCap<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = DenyCap.$isPhantom;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): DenyCapReified<ToPhantomTypeArgument<T>> { const reifiedBcs = DenyCap.bcs; return { typeName: DenyCap.$typeName, fullTypeName: composeSuiType( DenyCap.$typeName, ...[extractType(T)] ) as `0x2::coin::DenyCap<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: DenyCap.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => DenyCap.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DenyCap.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => DenyCap.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => DenyCap.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => DenyCap.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => DenyCap.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => DenyCap.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => DenyCap.fetch( client, T, id, ), new: ( fields: DenyCapFields<ToPhantomTypeArgument<T>>, ) => { return new DenyCap( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("DenyCap", {
 ...
 static get bcs(): ReturnType<typeof DenyCap.instantiateBcs> { if (!DenyCap.cachedBcs) { DenyCap.cachedBcs = DenyCap.instantiateBcs() } return DenyCap.cachedBcs };
