...
export class Random implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::random::Random`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Random.$typeName; readonly $fullTypeName: `0x2::random::Random`; readonly $typeArgs: []; readonly $isPhantom = Random.$isPhantom;
 ...
 static reified( ): RandomReified { const reifiedBcs = Random.bcs; return { typeName: Random.$typeName, fullTypeName: composeSuiType( Random.$typeName, ...[] ) as `0x2::random::Random`, typeArgs: [ ] as [], isPhantom: Random.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Random.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Random.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Random.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Random.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Random.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Random.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Random.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Random.fetch( client, id, ), new: ( fields: RandomFields, ) => { return new Random( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Random", {
 ...
 static get bcs(): ReturnType<typeof Random.instantiateBcs> { if (!Random.cachedBcs) { Random.cachedBcs = Random.instantiateBcs() } return Random.cachedBcs };
...
export class RandomInner implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::random::RandomInner`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = RandomInner.$typeName; readonly $fullTypeName: `0x2::random::RandomInner`; readonly $typeArgs: []; readonly $isPhantom = RandomInner.$isPhantom;
 ...
 static reified( ): RandomInnerReified { const reifiedBcs = RandomInner.bcs; return { typeName: RandomInner.$typeName, fullTypeName: composeSuiType( RandomInner.$typeName, ...[] ) as `0x2::random::RandomInner`, typeArgs: [ ] as [], isPhantom: RandomInner.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => RandomInner.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => RandomInner.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => RandomInner.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => RandomInner.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => RandomInner.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => RandomInner.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => RandomInner.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => RandomInner.fetch( client, id, ), new: ( fields: RandomInnerFields, ) => { return new RandomInner( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("RandomInner", {
 ...
 static get bcs(): ReturnType<typeof RandomInner.instantiateBcs> { if (!RandomInner.cachedBcs) { RandomInner.cachedBcs = RandomInner.instantiateBcs() } return RandomInner.cachedBcs };
...
export class RandomGenerator implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::random::RandomGenerator`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = RandomGenerator.$typeName; readonly $fullTypeName: `0x2::random::RandomGenerator`; readonly $typeArgs: []; readonly $isPhantom = RandomGenerator.$isPhantom;
 ...
 static reified( ): RandomGeneratorReified { const reifiedBcs = RandomGenerator.bcs; return { typeName: RandomGenerator.$typeName, fullTypeName: composeSuiType( RandomGenerator.$typeName, ...[] ) as `0x2::random::RandomGenerator`, typeArgs: [ ] as [], isPhantom: RandomGenerator.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => RandomGenerator.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => RandomGenerator.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => RandomGenerator.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => RandomGenerator.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => RandomGenerator.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => RandomGenerator.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => RandomGenerator.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => RandomGenerator.fetch( client, id, ), new: ( fields: RandomGeneratorFields, ) => { return new RandomGenerator( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("RandomGenerator", {
 ...
 static get bcs(): ReturnType<typeof RandomGenerator.instantiateBcs> { if (!RandomGenerator.cachedBcs) { RandomGenerator.cachedBcs = RandomGenerator.instantiateBcs() } return RandomGenerator.cachedBcs };
