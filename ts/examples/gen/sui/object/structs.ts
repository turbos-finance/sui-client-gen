...
export class ID implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::object::ID`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ID.$typeName; readonly $fullTypeName: `0x2::object::ID`; readonly $typeArgs: []; readonly $isPhantom = ID.$isPhantom;
 ...
 static reified( ): IDReified { const reifiedBcs = ID.bcs; return { typeName: ID.$typeName, fullTypeName: composeSuiType( ID.$typeName, ...[] ) as `0x2::object::ID`, typeArgs: [ ] as [], isPhantom: ID.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ID.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ID.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ID.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => ID.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ID.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ID.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => ID.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => ID.fetch( client, id, ), new: ( fields: IDFields, ) => { return new ID( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("ID", {
 ...
 static get bcs(): ReturnType<typeof ID.instantiateBcs> { if (!ID.cachedBcs) { ID.cachedBcs = ID.instantiateBcs() } return ID.cachedBcs };
...
export class UID implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::object::UID`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UID.$typeName; readonly $fullTypeName: `0x2::object::UID`; readonly $typeArgs: []; readonly $isPhantom = UID.$isPhantom;
 ...
 static reified( ): UIDReified { const reifiedBcs = UID.bcs; return { typeName: UID.$typeName, fullTypeName: composeSuiType( UID.$typeName, ...[] ) as `0x2::object::UID`, typeArgs: [ ] as [], isPhantom: UID.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UID.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UID.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UID.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => UID.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UID.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UID.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UID.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UID.fetch( client, id, ), new: ( fields: UIDFields, ) => { return new UID( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("UID", {
 ...
 static get bcs(): ReturnType<typeof UID.instantiateBcs> { if (!UID.cachedBcs) { UID.cachedBcs = UID.instantiateBcs() } return UID.cachedBcs };
