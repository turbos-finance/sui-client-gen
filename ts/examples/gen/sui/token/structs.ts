...
export class Token<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::token::Token`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = Token.$typeName; readonly $fullTypeName: `0x2::token::Token<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = Token.$isPhantom;
 ...
 private static instantiateBcs() { return bcs.struct("Token", {
 ...
 static get bcs(): ReturnType<typeof Token.instantiateBcs> { if (!Token.cachedBcs) { Token.cachedBcs = Token.instantiateBcs() } return Token.cachedBcs };
...
export class TokenPolicyCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::token::TokenPolicyCap`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TokenPolicyCap.$typeName; readonly $fullTypeName: `0x2::token::TokenPolicyCap<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TokenPolicyCap.$isPhantom;
 ...
 private static instantiateBcs() { return bcs.struct("TokenPolicyCap", {
 ...
 static get bcs(): ReturnType<typeof TokenPolicyCap.instantiateBcs> { if (!TokenPolicyCap.cachedBcs) { TokenPolicyCap.cachedBcs = TokenPolicyCap.instantiateBcs() } return TokenPolicyCap.cachedBcs };
...
export class TokenPolicy<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::token::TokenPolicy`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TokenPolicy.$typeName; readonly $fullTypeName: `0x2::token::TokenPolicy<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TokenPolicy.$isPhantom;
 ...
 private static instantiateBcs() { return bcs.struct("TokenPolicy", {
 ...
 static get bcs(): ReturnType<typeof TokenPolicy.instantiateBcs> { if (!TokenPolicy.cachedBcs) { TokenPolicy.cachedBcs = TokenPolicy.instantiateBcs() } return TokenPolicy.cachedBcs };
...
export class ActionRequest<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::token::ActionRequest`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = ActionRequest.$typeName; readonly $fullTypeName: `0x2::token::ActionRequest<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = ActionRequest.$isPhantom;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): ActionRequestReified<ToPhantomTypeArgument<T>> { const reifiedBcs = ActionRequest.bcs; return { typeName: ActionRequest.$typeName, fullTypeName: composeSuiType( ActionRequest.$typeName, ...[extractType(T)] ) as `0x2::token::ActionRequest<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: ActionRequest.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => ActionRequest.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ActionRequest.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => ActionRequest.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => ActionRequest.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => ActionRequest.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => ActionRequest.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => ActionRequest.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => ActionRequest.fetch( client, T, id, ), new: ( fields: ActionRequestFields<ToPhantomTypeArgument<T>>, ) => { return new ActionRequest( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("ActionRequest", {
 ...
 static get bcs(): ReturnType<typeof ActionRequest.instantiateBcs> { if (!ActionRequest.cachedBcs) { ActionRequest.cachedBcs = ActionRequest.instantiateBcs() } return ActionRequest.cachedBcs };
...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::token::RuleKey`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = RuleKey.$typeName; readonly $fullTypeName: `0x2::token::RuleKey<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = RuleKey.$isPhantom;
...
export class TokenPolicyCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::token::TokenPolicyCreated`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TokenPolicyCreated.$typeName; readonly $fullTypeName: `0x2::token::TokenPolicyCreated<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TokenPolicyCreated.$isPhantom;
 ...
 private static instantiateBcs() { return bcs.struct("TokenPolicyCreated", {
 ...
 static get bcs(): ReturnType<typeof TokenPolicyCreated.instantiateBcs> { if (!TokenPolicyCreated.cachedBcs) { TokenPolicyCreated.cachedBcs = TokenPolicyCreated.instantiateBcs() } return TokenPolicyCreated.cachedBcs };
