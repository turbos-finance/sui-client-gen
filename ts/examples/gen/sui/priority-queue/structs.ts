...
export class PriorityQueue<T extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::priority_queue::PriorityQueue`; static readonly $numTypeParams = 1; static readonly $isPhantom = [false,] as const;

 readonly $typeName = PriorityQueue.$typeName; readonly $fullTypeName: `0x2::priority_queue::PriorityQueue<${ToTypeStr<T>}>`; readonly $typeArgs: [ToTypeStr<T>]; readonly $isPhantom = PriorityQueue.$isPhantom;
 ...
 static reified<T extends Reified<TypeArgument, any>>( T: T ): PriorityQueueReified<ToTypeArgument<T>> { const reifiedBcs = PriorityQueue.bcs(toBcs(T)); return { typeName: PriorityQueue.$typeName, fullTypeName: composeSuiType( PriorityQueue.$typeName, ...[extractType(T)] ) as `0x2::priority_queue::PriorityQueue<${ToTypeStr<ToTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [ToTypeStr<ToTypeArgument<T>>], isPhantom: PriorityQueue.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => PriorityQueue.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => PriorityQueue.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => PriorityQueue.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => PriorityQueue.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => PriorityQueue.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => PriorityQueue.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => PriorityQueue.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => PriorityQueue.fetch( client, T, id, ), new: ( fields: PriorityQueueFields<ToTypeArgument<T>>, ) => { return new PriorityQueue( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return <T extends BcsType<any>>(T: T) => bcs.struct(`PriorityQueue<${T.name}>`, {
 ...
 static get bcs(): ReturnType<typeof PriorityQueue.instantiateBcs> { if (!PriorityQueue.cachedBcs) { PriorityQueue.cachedBcs = PriorityQueue.instantiateBcs() } return PriorityQueue.cachedBcs };
...
export class Entry<T extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::priority_queue::Entry`; static readonly $numTypeParams = 1; static readonly $isPhantom = [false,] as const;

 readonly $typeName = Entry.$typeName; readonly $fullTypeName: `0x2::priority_queue::Entry<${ToTypeStr<T>}>`; readonly $typeArgs: [ToTypeStr<T>]; readonly $isPhantom = Entry.$isPhantom;
 ...
 static reified<T extends Reified<TypeArgument, any>>( T: T ): EntryReified<ToTypeArgument<T>> { const reifiedBcs = Entry.bcs(toBcs(T)); return { typeName: Entry.$typeName, fullTypeName: composeSuiType( Entry.$typeName, ...[extractType(T)] ) as `0x2::priority_queue::Entry<${ToTypeStr<ToTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [ToTypeStr<ToTypeArgument<T>>], isPhantom: Entry.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => Entry.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Entry.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => Entry.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Entry.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => Entry.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => Entry.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => Entry.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => Entry.fetch( client, T, id, ), new: ( fields: EntryFields<ToTypeArgument<T>>, ) => { return new Entry( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return <T extends BcsType<any>>(T: T) => bcs.struct(`Entry<${T.name}>`, {
