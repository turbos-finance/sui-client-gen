...
export class Kiosk implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::kiosk::Kiosk`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Kiosk.$typeName; readonly $fullTypeName: `0x2::kiosk::Kiosk`; readonly $typeArgs: []; readonly $isPhantom = Kiosk.$isPhantom;
 ...
 static reified( ): KioskReified { const reifiedBcs = Kiosk.bcs; return { typeName: Kiosk.$typeName, fullTypeName: composeSuiType( Kiosk.$typeName, ...[] ) as `0x2::kiosk::Kiosk`, typeArgs: [ ] as [], isPhantom: Kiosk.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Kiosk.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Kiosk.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Kiosk.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Kiosk.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Kiosk.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Kiosk.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Kiosk.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Kiosk.fetch( client, id, ), new: ( fields: KioskFields, ) => { return new Kiosk( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Kiosk", {
 ...
 static get bcs(): ReturnType<typeof Kiosk.instantiateBcs> { if (!Kiosk.cachedBcs) { Kiosk.cachedBcs = Kiosk.instantiateBcs() } return Kiosk.cachedBcs };
...
export class KioskOwnerCap implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::kiosk::KioskOwnerCap`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = KioskOwnerCap.$typeName; readonly $fullTypeName: `0x2::kiosk::KioskOwnerCap`; readonly $typeArgs: []; readonly $isPhantom = KioskOwnerCap.$isPhantom;
 ...
 static reified( ): KioskOwnerCapReified { const reifiedBcs = KioskOwnerCap.bcs; return { typeName: KioskOwnerCap.$typeName, fullTypeName: composeSuiType( KioskOwnerCap.$typeName, ...[] ) as `0x2::kiosk::KioskOwnerCap`, typeArgs: [ ] as [], isPhantom: KioskOwnerCap.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => KioskOwnerCap.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => KioskOwnerCap.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => KioskOwnerCap.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => KioskOwnerCap.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => KioskOwnerCap.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => KioskOwnerCap.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => KioskOwnerCap.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => KioskOwnerCap.fetch( client, id, ), new: ( fields: KioskOwnerCapFields, ) => { return new KioskOwnerCap( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("KioskOwnerCap", {
 ...
 static get bcs(): ReturnType<typeof KioskOwnerCap.instantiateBcs> { if (!KioskOwnerCap.cachedBcs) { KioskOwnerCap.cachedBcs = KioskOwnerCap.instantiateBcs() } return KioskOwnerCap.cachedBcs };
...
export class PurchaseCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::kiosk::PurchaseCap`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = PurchaseCap.$typeName; readonly $fullTypeName: `0x2::kiosk::PurchaseCap<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = PurchaseCap.$isPhantom;
 ...
 private static instantiateBcs() { return bcs.struct("PurchaseCap", {
 ...
 static get bcs(): ReturnType<typeof PurchaseCap.instantiateBcs> { if (!PurchaseCap.cachedBcs) { PurchaseCap.cachedBcs = PurchaseCap.instantiateBcs() } return PurchaseCap.cachedBcs };
...
export class Borrow implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::kiosk::Borrow`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Borrow.$typeName; readonly $fullTypeName: `0x2::kiosk::Borrow`; readonly $typeArgs: []; readonly $isPhantom = Borrow.$isPhantom;
 ...
 static reified( ): BorrowReified { const reifiedBcs = Borrow.bcs; return { typeName: Borrow.$typeName, fullTypeName: composeSuiType( Borrow.$typeName, ...[] ) as `0x2::kiosk::Borrow`, typeArgs: [ ] as [], isPhantom: Borrow.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Borrow.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Borrow.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Borrow.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Borrow.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Borrow.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Borrow.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Borrow.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Borrow.fetch( client, id, ), new: ( fields: BorrowFields, ) => { return new Borrow( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Borrow", {
 ...
 static get bcs(): ReturnType<typeof Borrow.instantiateBcs> { if (!Borrow.cachedBcs) { Borrow.cachedBcs = Borrow.instantiateBcs() } return Borrow.cachedBcs };
...
export class Item implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::kiosk::Item`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Item.$typeName; readonly $fullTypeName: `0x2::kiosk::Item`; readonly $typeArgs: []; readonly $isPhantom = Item.$isPhantom;
 ...
 static reified( ): ItemReified { const reifiedBcs = Item.bcs; return { typeName: Item.$typeName, fullTypeName: composeSuiType( Item.$typeName, ...[] ) as `0x2::kiosk::Item`, typeArgs: [ ] as [], isPhantom: Item.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Item.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Item.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Item.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Item.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Item.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Item.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Item.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Item.fetch( client, id, ), new: ( fields: ItemFields, ) => { return new Item( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Item", {
 ...
 static get bcs(): ReturnType<typeof Item.instantiateBcs> { if (!Item.cachedBcs) { Item.cachedBcs = Item.instantiateBcs() } return Item.cachedBcs };
...
export class Listing implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::kiosk::Listing`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Listing.$typeName; readonly $fullTypeName: `0x2::kiosk::Listing`; readonly $typeArgs: []; readonly $isPhantom = Listing.$isPhantom;
 ...
 static reified( ): ListingReified { const reifiedBcs = Listing.bcs; return { typeName: Listing.$typeName, fullTypeName: composeSuiType( Listing.$typeName, ...[] ) as `0x2::kiosk::Listing`, typeArgs: [ ] as [], isPhantom: Listing.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Listing.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Listing.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Listing.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Listing.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Listing.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Listing.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Listing.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Listing.fetch( client, id, ), new: ( fields: ListingFields, ) => { return new Listing( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Listing", {
 ...
 static get bcs(): ReturnType<typeof Listing.instantiateBcs> { if (!Listing.cachedBcs) { Listing.cachedBcs = Listing.instantiateBcs() } return Listing.cachedBcs };
...
export class Lock implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::kiosk::Lock`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Lock.$typeName; readonly $fullTypeName: `0x2::kiosk::Lock`; readonly $typeArgs: []; readonly $isPhantom = Lock.$isPhantom;
 ...
 static reified( ): LockReified { const reifiedBcs = Lock.bcs; return { typeName: Lock.$typeName, fullTypeName: composeSuiType( Lock.$typeName, ...[] ) as `0x2::kiosk::Lock`, typeArgs: [ ] as [], isPhantom: Lock.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Lock.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Lock.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Lock.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Lock.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Lock.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Lock.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Lock.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Lock.fetch( client, id, ), new: ( fields: LockFields, ) => { return new Lock( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Lock", {
 ...
 static get bcs(): ReturnType<typeof Lock.instantiateBcs> { if (!Lock.cachedBcs) { Lock.cachedBcs = Lock.instantiateBcs() } return Lock.cachedBcs };
...
export class ItemListed<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::kiosk::ItemListed`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = ItemListed.$typeName; readonly $fullTypeName: `0x2::kiosk::ItemListed<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = ItemListed.$isPhantom;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): ItemListedReified<ToPhantomTypeArgument<T>> { const reifiedBcs = ItemListed.bcs; return { typeName: ItemListed.$typeName, fullTypeName: composeSuiType( ItemListed.$typeName, ...[extractType(T)] ) as `0x2::kiosk::ItemListed<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: ItemListed.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => ItemListed.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ItemListed.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => ItemListed.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => ItemListed.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => ItemListed.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => ItemListed.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => ItemListed.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => ItemListed.fetch( client, T, id, ), new: ( fields: ItemListedFields<ToPhantomTypeArgument<T>>, ) => { return new ItemListed( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("ItemListed", {
 ...
 static get bcs(): ReturnType<typeof ItemListed.instantiateBcs> { if (!ItemListed.cachedBcs) { ItemListed.cachedBcs = ItemListed.instantiateBcs() } return ItemListed.cachedBcs };
...
export class ItemPurchased<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::kiosk::ItemPurchased`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = ItemPurchased.$typeName; readonly $fullTypeName: `0x2::kiosk::ItemPurchased<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = ItemPurchased.$isPhantom;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): ItemPurchasedReified<ToPhantomTypeArgument<T>> { const reifiedBcs = ItemPurchased.bcs; return { typeName: ItemPurchased.$typeName, fullTypeName: composeSuiType( ItemPurchased.$typeName, ...[extractType(T)] ) as `0x2::kiosk::ItemPurchased<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: ItemPurchased.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => ItemPurchased.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ItemPurchased.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => ItemPurchased.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => ItemPurchased.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => ItemPurchased.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => ItemPurchased.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => ItemPurchased.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => ItemPurchased.fetch( client, T, id, ), new: ( fields: ItemPurchasedFields<ToPhantomTypeArgument<T>>, ) => { return new ItemPurchased( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("ItemPurchased", {
 ...
 static get bcs(): ReturnType<typeof ItemPurchased.instantiateBcs> { if (!ItemPurchased.cachedBcs) { ItemPurchased.cachedBcs = ItemPurchased.instantiateBcs() } return ItemPurchased.cachedBcs };
...
export class ItemDelisted<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::kiosk::ItemDelisted`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = ItemDelisted.$typeName; readonly $fullTypeName: `0x2::kiosk::ItemDelisted<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = ItemDelisted.$isPhantom;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): ItemDelistedReified<ToPhantomTypeArgument<T>> { const reifiedBcs = ItemDelisted.bcs; return { typeName: ItemDelisted.$typeName, fullTypeName: composeSuiType( ItemDelisted.$typeName, ...[extractType(T)] ) as `0x2::kiosk::ItemDelisted<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: ItemDelisted.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => ItemDelisted.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ItemDelisted.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => ItemDelisted.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => ItemDelisted.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => ItemDelisted.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => ItemDelisted.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => ItemDelisted.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => ItemDelisted.fetch( client, T, id, ), new: ( fields: ItemDelistedFields<ToPhantomTypeArgument<T>>, ) => { return new ItemDelisted( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("ItemDelisted", {
 ...
 static get bcs(): ReturnType<typeof ItemDelisted.instantiateBcs> { if (!ItemDelisted.cachedBcs) { ItemDelisted.cachedBcs = ItemDelisted.instantiateBcs() } return ItemDelisted.cachedBcs };
