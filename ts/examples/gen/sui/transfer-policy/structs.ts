...
export class TransferRequest<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::transfer_policy::TransferRequest`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferRequest.$typeName; readonly $fullTypeName: `0x2::transfer_policy::TransferRequest<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TransferRequest.$isPhantom;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TransferRequestReified<ToPhantomTypeArgument<T>> { const reifiedBcs = TransferRequest.bcs; return { typeName: TransferRequest.$typeName, fullTypeName: composeSuiType( TransferRequest.$typeName, ...[extractType(T)] ) as `0x2::transfer_policy::TransferRequest<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TransferRequest.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TransferRequest.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferRequest.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TransferRequest.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => TransferRequest.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TransferRequest.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferRequest.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TransferRequest.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TransferRequest.fetch( client, T, id, ), new: ( fields: TransferRequestFields<ToPhantomTypeArgument<T>>, ) => { return new TransferRequest( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("TransferRequest", {
 ...
 static get bcs(): ReturnType<typeof TransferRequest.instantiateBcs> { if (!TransferRequest.cachedBcs) { TransferRequest.cachedBcs = TransferRequest.instantiateBcs() } return TransferRequest.cachedBcs };
...
export class TransferPolicy<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::transfer_policy::TransferPolicy`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferPolicy.$typeName; readonly $fullTypeName: `0x2::transfer_policy::TransferPolicy<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TransferPolicy.$isPhantom;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TransferPolicyReified<ToPhantomTypeArgument<T>> { const reifiedBcs = TransferPolicy.bcs; return { typeName: TransferPolicy.$typeName, fullTypeName: composeSuiType( TransferPolicy.$typeName, ...[extractType(T)] ) as `0x2::transfer_policy::TransferPolicy<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TransferPolicy.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TransferPolicy.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicy.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TransferPolicy.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => TransferPolicy.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TransferPolicy.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicy.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TransferPolicy.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicy.fetch( client, T, id, ), new: ( fields: TransferPolicyFields<ToPhantomTypeArgument<T>>, ) => { return new TransferPolicy( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("TransferPolicy", {
 ...
 static get bcs(): ReturnType<typeof TransferPolicy.instantiateBcs> { if (!TransferPolicy.cachedBcs) { TransferPolicy.cachedBcs = TransferPolicy.instantiateBcs() } return TransferPolicy.cachedBcs };
...
export class TransferPolicyCap<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::transfer_policy::TransferPolicyCap`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferPolicyCap.$typeName; readonly $fullTypeName: `0x2::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TransferPolicyCap.$isPhantom;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TransferPolicyCapReified<ToPhantomTypeArgument<T>> { const reifiedBcs = TransferPolicyCap.bcs; return { typeName: TransferPolicyCap.$typeName, fullTypeName: composeSuiType( TransferPolicyCap.$typeName, ...[extractType(T)] ) as `0x2::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TransferPolicyCap.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TransferPolicyCap.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyCap.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TransferPolicyCap.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => TransferPolicyCap.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TransferPolicyCap.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicyCap.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TransferPolicyCap.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicyCap.fetch( client, T, id, ), new: ( fields: TransferPolicyCapFields<ToPhantomTypeArgument<T>>, ) => { return new TransferPolicyCap( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("TransferPolicyCap", {
 ...
 static get bcs(): ReturnType<typeof TransferPolicyCap.instantiateBcs> { if (!TransferPolicyCap.cachedBcs) { TransferPolicyCap.cachedBcs = TransferPolicyCap.instantiateBcs() } return TransferPolicyCap.cachedBcs };
...
export class TransferPolicyCreated<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::transfer_policy::TransferPolicyCreated`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferPolicyCreated.$typeName; readonly $fullTypeName: `0x2::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TransferPolicyCreated.$isPhantom;
 ...
 private static instantiateBcs() { return bcs.struct("TransferPolicyCreated", {
 ...
 static get bcs(): ReturnType<typeof TransferPolicyCreated.instantiateBcs> { if (!TransferPolicyCreated.cachedBcs) { TransferPolicyCreated.cachedBcs = TransferPolicyCreated.instantiateBcs() } return TransferPolicyCreated.cachedBcs };
...
export class TransferPolicyDestroyed<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::transfer_policy::TransferPolicyDestroyed`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = TransferPolicyDestroyed.$typeName; readonly $fullTypeName: `0x2::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = TransferPolicyDestroyed.$isPhantom;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): TransferPolicyDestroyedReified<ToPhantomTypeArgument<T>> { const reifiedBcs = TransferPolicyDestroyed.bcs; return { typeName: TransferPolicyDestroyed.$typeName, fullTypeName: composeSuiType( TransferPolicyDestroyed.$typeName, ...[extractType(T)] ) as `0x2::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: TransferPolicyDestroyed.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => TransferPolicyDestroyed.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyDestroyed.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => TransferPolicyDestroyed.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => TransferPolicyDestroyed.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => TransferPolicyDestroyed.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicyDestroyed.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => TransferPolicyDestroyed.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicyDestroyed.fetch( client, T, id, ), new: ( fields: TransferPolicyDestroyedFields<ToPhantomTypeArgument<T>>, ) => { return new TransferPolicyDestroyed( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("TransferPolicyDestroyed", {
 ...
 static get bcs(): ReturnType<typeof TransferPolicyDestroyed.instantiateBcs> { if (!TransferPolicyDestroyed.cachedBcs) { TransferPolicyDestroyed.cachedBcs = TransferPolicyDestroyed.instantiateBcs() } return TransferPolicyDestroyed.cachedBcs };
...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::transfer_policy::RuleKey`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = RuleKey.$typeName; readonly $fullTypeName: `0x2::transfer_policy::RuleKey<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = RuleKey.$isPhantom;
 ...
 private static instantiateBcs() { return bcs.struct("RuleKey", {
 ...
 static get bcs(): ReturnType<typeof RuleKey.instantiateBcs> { if (!RuleKey.cachedBcs) { RuleKey.cachedBcs = RuleKey.instantiateBcs() } return RuleKey.cachedBcs };
