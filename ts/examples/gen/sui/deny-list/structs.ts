...
export class DenyList implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::deny_list::DenyList`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = DenyList.$typeName; readonly $fullTypeName: `0x2::deny_list::DenyList`; readonly $typeArgs: []; readonly $isPhantom = DenyList.$isPhantom;
 ...
 static reified( ): DenyListReified { const reifiedBcs = DenyList.bcs; return { typeName: DenyList.$typeName, fullTypeName: composeSuiType( DenyList.$typeName, ...[] ) as `0x2::deny_list::DenyList`, typeArgs: [ ] as [], isPhantom: DenyList.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => DenyList.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DenyList.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => DenyList.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => DenyList.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => DenyList.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => DenyList.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => DenyList.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => DenyList.fetch( client, id, ), new: ( fields: DenyListFields, ) => { return new DenyList( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("DenyList", {
 ...
 static get bcs(): ReturnType<typeof DenyList.instantiateBcs> { if (!DenyList.cachedBcs) { DenyList.cachedBcs = DenyList.instantiateBcs() } return DenyList.cachedBcs };
...
export function isConfigWriteCap(type: string): boolean { type = compressSuiType(type); return type === `0x2::deny_list::ConfigWriteCap`; }
...
export class ConfigWriteCap implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::deny_list::ConfigWriteCap`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ConfigWriteCap.$typeName; readonly $fullTypeName: `0x2::deny_list::ConfigWriteCap`; readonly $typeArgs: []; readonly $isPhantom = ConfigWriteCap.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: ConfigWriteCapFields, ) { this.$fullTypeName = composeSuiType( ConfigWriteCap.$typeName, ...typeArgs ) as `0x2::deny_list::ConfigWriteCap`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): ConfigWriteCapReified { const reifiedBcs = ConfigWriteCap.bcs; return { typeName: ConfigWriteCap.$typeName, fullTypeName: composeSuiType( ConfigWriteCap.$typeName, ...[] ) as `0x2::deny_list::ConfigWriteCap`, typeArgs: [ ] as [], isPhantom: ConfigWriteCap.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ConfigWriteCap.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ConfigWriteCap.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ConfigWriteCap.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => ConfigWriteCap.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ConfigWriteCap.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ConfigWriteCap.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => ConfigWriteCap.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => ConfigWriteCap.fetch( client, id, ), new: ( fields: ConfigWriteCapFields, ) => { return new ConfigWriteCap( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("ConfigWriteCap", {
 ...
 static get bcs(): ReturnType<typeof ConfigWriteCap.instantiateBcs> { if (!ConfigWriteCap.cachedBcs) { ConfigWriteCap.cachedBcs = ConfigWriteCap.instantiateBcs() } return ConfigWriteCap.cachedBcs };
...
export function isConfigKey(type: string): boolean { type = compressSuiType(type); return type === `0x2::deny_list::ConfigKey`; }
...
export class ConfigKey implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::deny_list::ConfigKey`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ConfigKey.$typeName; readonly $fullTypeName: `0x2::deny_list::ConfigKey`; readonly $typeArgs: []; readonly $isPhantom = ConfigKey.$isPhantom;

 readonly perTypeIndex: ToField<"u64">; readonly perTypeKey: ToField<Vector<"u8">>

 private constructor(typeArgs: [], fields: ConfigKeyFields, ) { this.$fullTypeName = composeSuiType( ConfigKey.$typeName, ...typeArgs ) as `0x2::deny_list::ConfigKey`; this.$typeArgs = typeArgs;

 this.perTypeIndex = fields.perTypeIndex;; this.perTypeKey = fields.perTypeKey; }

 static reified( ): ConfigKeyReified { const reifiedBcs = ConfigKey.bcs; return { typeName: ConfigKey.$typeName, fullTypeName: composeSuiType( ConfigKey.$typeName, ...[] ) as `0x2::deny_list::ConfigKey`, typeArgs: [ ] as [], isPhantom: ConfigKey.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ConfigKey.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ConfigKey.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ConfigKey.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => ConfigKey.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ConfigKey.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ConfigKey.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => ConfigKey.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => ConfigKey.fetch( client, id, ), new: ( fields: ConfigKeyFields, ) => { return new ConfigKey( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("ConfigKey", {
 ...
 static get bcs(): ReturnType<typeof ConfigKey.instantiateBcs> { if (!ConfigKey.cachedBcs) { ConfigKey.cachedBcs = ConfigKey.instantiateBcs() } return ConfigKey.cachedBcs };
...
export function isAddressKey(type: string): boolean { type = compressSuiType(type); return type === `0x2::deny_list::AddressKey`; }
...
export class AddressKey implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::deny_list::AddressKey`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = AddressKey.$typeName; readonly $fullTypeName: `0x2::deny_list::AddressKey`; readonly $typeArgs: []; readonly $isPhantom = AddressKey.$isPhantom;

 readonly pos0: ToField<"address">

 private constructor(typeArgs: [], fields: AddressKeyFields, ) { this.$fullTypeName = composeSuiType( AddressKey.$typeName, ...typeArgs ) as `0x2::deny_list::AddressKey`; this.$typeArgs = typeArgs;

 this.pos0 = fields.pos0; }

 static reified( ): AddressKeyReified { const reifiedBcs = AddressKey.bcs; return { typeName: AddressKey.$typeName, fullTypeName: composeSuiType( AddressKey.$typeName, ...[] ) as `0x2::deny_list::AddressKey`, typeArgs: [ ] as [], isPhantom: AddressKey.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => AddressKey.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => AddressKey.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => AddressKey.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => AddressKey.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => AddressKey.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => AddressKey.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => AddressKey.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => AddressKey.fetch( client, id, ), new: ( fields: AddressKeyFields, ) => { return new AddressKey( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("AddressKey", {
 ...
 static get bcs(): ReturnType<typeof AddressKey.instantiateBcs> { if (!AddressKey.cachedBcs) { AddressKey.cachedBcs = AddressKey.instantiateBcs() } return AddressKey.cachedBcs };
...
export function isGlobalPauseKey(type: string): boolean { type = compressSuiType(type); return type === `0x2::deny_list::GlobalPauseKey`; }
...
export class GlobalPauseKey implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::deny_list::GlobalPauseKey`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = GlobalPauseKey.$typeName; readonly $fullTypeName: `0x2::deny_list::GlobalPauseKey`; readonly $typeArgs: []; readonly $isPhantom = GlobalPauseKey.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: GlobalPauseKeyFields, ) { this.$fullTypeName = composeSuiType( GlobalPauseKey.$typeName, ...typeArgs ) as `0x2::deny_list::GlobalPauseKey`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): GlobalPauseKeyReified { const reifiedBcs = GlobalPauseKey.bcs; return { typeName: GlobalPauseKey.$typeName, fullTypeName: composeSuiType( GlobalPauseKey.$typeName, ...[] ) as `0x2::deny_list::GlobalPauseKey`, typeArgs: [ ] as [], isPhantom: GlobalPauseKey.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => GlobalPauseKey.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => GlobalPauseKey.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => GlobalPauseKey.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => GlobalPauseKey.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => GlobalPauseKey.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => GlobalPauseKey.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => GlobalPauseKey.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => GlobalPauseKey.fetch( client, id, ), new: ( fields: GlobalPauseKeyFields, ) => { return new GlobalPauseKey( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("GlobalPauseKey", {
 ...
 static get bcs(): ReturnType<typeof GlobalPauseKey.instantiateBcs> { if (!GlobalPauseKey.cachedBcs) { GlobalPauseKey.cachedBcs = GlobalPauseKey.instantiateBcs() } return GlobalPauseKey.cachedBcs };
...
export function isPerTypeConfigCreated(type: string): boolean { type = compressSuiType(type); return type === `0x2::deny_list::PerTypeConfigCreated`; }
...
export class PerTypeConfigCreated implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::deny_list::PerTypeConfigCreated`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = PerTypeConfigCreated.$typeName; readonly $fullTypeName: `0x2::deny_list::PerTypeConfigCreated`; readonly $typeArgs: []; readonly $isPhantom = PerTypeConfigCreated.$isPhantom;

 readonly key: ToField<ConfigKey>; readonly configId: ToField<ID>

 private constructor(typeArgs: [], fields: PerTypeConfigCreatedFields, ) { this.$fullTypeName = composeSuiType( PerTypeConfigCreated.$typeName, ...typeArgs ) as `0x2::deny_list::PerTypeConfigCreated`; this.$typeArgs = typeArgs;

 this.key = fields.key;; this.configId = fields.configId; }

 static reified( ): PerTypeConfigCreatedReified { const reifiedBcs = PerTypeConfigCreated.bcs; return { typeName: PerTypeConfigCreated.$typeName, fullTypeName: composeSuiType( PerTypeConfigCreated.$typeName, ...[] ) as `0x2::deny_list::PerTypeConfigCreated`, typeArgs: [ ] as [], isPhantom: PerTypeConfigCreated.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => PerTypeConfigCreated.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => PerTypeConfigCreated.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => PerTypeConfigCreated.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => PerTypeConfigCreated.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => PerTypeConfigCreated.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => PerTypeConfigCreated.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => PerTypeConfigCreated.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => PerTypeConfigCreated.fetch( client, id, ), new: ( fields: PerTypeConfigCreatedFields, ) => { return new PerTypeConfigCreated( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("PerTypeConfigCreated", {
 ...
 static get bcs(): ReturnType<typeof PerTypeConfigCreated.instantiateBcs> { if (!PerTypeConfigCreated.cachedBcs) { PerTypeConfigCreated.cachedBcs = PerTypeConfigCreated.instantiateBcs() } return PerTypeConfigCreated.cachedBcs };
...
export class PerTypeList implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::deny_list::PerTypeList`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = PerTypeList.$typeName; readonly $fullTypeName: `0x2::deny_list::PerTypeList`; readonly $typeArgs: []; readonly $isPhantom = PerTypeList.$isPhantom;
 ...
 static reified( ): PerTypeListReified { const reifiedBcs = PerTypeList.bcs; return { typeName: PerTypeList.$typeName, fullTypeName: composeSuiType( PerTypeList.$typeName, ...[] ) as `0x2::deny_list::PerTypeList`, typeArgs: [ ] as [], isPhantom: PerTypeList.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => PerTypeList.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => PerTypeList.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => PerTypeList.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => PerTypeList.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => PerTypeList.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => PerTypeList.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => PerTypeList.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => PerTypeList.fetch( client, id, ), new: ( fields: PerTypeListFields, ) => { return new PerTypeList( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("PerTypeList", {
 ...
 static get bcs(): ReturnType<typeof PerTypeList.instantiateBcs> { if (!PerTypeList.cachedBcs) { PerTypeList.cachedBcs = PerTypeList.instantiateBcs() } return PerTypeList.cachedBcs };
