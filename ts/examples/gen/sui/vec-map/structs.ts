...
export class VecMap<K extends TypeArgument, V extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::vec_map::VecMap`; static readonly $numTypeParams = 2; static readonly $isPhantom = [false,false,] as const;

 readonly $typeName = VecMap.$typeName; readonly $fullTypeName: `0x2::vec_map::VecMap<${ToTypeStr<K>}, ${ToTypeStr<V>}>`; readonly $typeArgs: [ToTypeStr<K>, ToTypeStr<V>]; readonly $isPhantom = VecMap.$isPhantom;
 ...
 static reified<K extends Reified<TypeArgument, any>, V extends Reified<TypeArgument, any>>( K: K, V: V ): VecMapReified<ToTypeArgument<K>, ToTypeArgument<V>> { const reifiedBcs = VecMap.bcs(toBcs(K), toBcs(V)); return { typeName: VecMap.$typeName, fullTypeName: composeSuiType( VecMap.$typeName, ...[extractType(K), extractType(V)] ) as `0x2::vec_map::VecMap<${ToTypeStr<ToTypeArgument<K>>}, ${ToTypeStr<ToTypeArgument<V>>}>`, typeArgs: [ extractType(K), extractType(V) ] as [ToTypeStr<ToTypeArgument<K>>, ToTypeStr<ToTypeArgument<V>>], isPhantom: VecMap.$isPhantom, reifiedTypeArgs: [K, V], fromFields: (fields: Record<string, any>) => VecMap.fromFields( [K, V], fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => VecMap.fromFieldsWithTypes( [K, V], item, ), fromBcs: (data: Uint8Array) => VecMap.fromFields( [K, V], reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => VecMap.fromJSONField( [K, V], field, ), fromJSON: (json: Record<string, any>) => VecMap.fromJSON( [K, V], json, ), fromSuiParsedData: (content: SuiParsedData) => VecMap.fromSuiParsedData( [K, V], content, ), fromSuiObjectData: (content: SuiObjectData) => VecMap.fromSuiObjectData( [K, V], content, ), fetch: async (client: SuiClient, id: string) => VecMap.fetch( client, [K, V], id, ), new: ( fields: VecMapFields<ToTypeArgument<K>, ToTypeArgument<V>>, ) => { return new VecMap( [extractType(K), extractType(V)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return <K extends BcsType<any>, V extends BcsType<any>>(K: K, V: V) => bcs.struct(`VecMap<${K.name}, ${V.name}>`, {
 ...
 static get bcs(): ReturnType<typeof VecMap.instantiateBcs> { if (!VecMap.cachedBcs) { VecMap.cachedBcs = VecMap.instantiateBcs() } return VecMap.cachedBcs };
...
export class Entry<K extends TypeArgument, V extends TypeArgument> implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x2::vec_map::Entry`; static readonly $numTypeParams = 2; static readonly $isPhantom = [false,false,] as const;

 readonly $typeName = Entry.$typeName; readonly $fullTypeName: `0x2::vec_map::Entry<${ToTypeStr<K>}, ${ToTypeStr<V>}>`; readonly $typeArgs: [ToTypeStr<K>, ToTypeStr<V>]; readonly $isPhantom = Entry.$isPhantom;
 ...
 static reified<K extends Reified<TypeArgument, any>, V extends Reified<TypeArgument, any>>( K: K, V: V ): EntryReified<ToTypeArgument<K>, ToTypeArgument<V>> { const reifiedBcs = Entry.bcs(toBcs(K), toBcs(V)); return { typeName: Entry.$typeName, fullTypeName: composeSuiType( Entry.$typeName, ...[extractType(K), extractType(V)] ) as `0x2::vec_map::Entry<${ToTypeStr<ToTypeArgument<K>>}, ${ToTypeStr<ToTypeArgument<V>>}>`, typeArgs: [ extractType(K), extractType(V) ] as [ToTypeStr<ToTypeArgument<K>>, ToTypeStr<ToTypeArgument<V>>], isPhantom: Entry.$isPhantom, reifiedTypeArgs: [K, V], fromFields: (fields: Record<string, any>) => Entry.fromFields( [K, V], fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Entry.fromFieldsWithTypes( [K, V], item, ), fromBcs: (data: Uint8Array) => Entry.fromFields( [K, V], reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Entry.fromJSONField( [K, V], field, ), fromJSON: (json: Record<string, any>) => Entry.fromJSON( [K, V], json, ), fromSuiParsedData: (content: SuiParsedData) => Entry.fromSuiParsedData( [K, V], content, ), fromSuiObjectData: (content: SuiObjectData) => Entry.fromSuiObjectData( [K, V], content, ), fetch: async (client: SuiClient, id: string) => Entry.fetch( client, [K, V], id, ), new: ( fields: EntryFields<ToTypeArgument<K>, ToTypeArgument<V>>, ) => { return new Entry( [extractType(K), extractType(V)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return <K extends BcsType<any>, V extends BcsType<any>>(K: K, V: V) => bcs.struct(`Entry<${K.name}, ${V.name}>`, {
 ...
 static get bcs(): ReturnType<typeof Entry.instantiateBcs> { if (!Entry.cachedBcs) { Entry.cachedBcs = Entry.instantiateBcs() } return Entry.cachedBcs };
