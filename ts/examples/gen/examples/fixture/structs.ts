...
export class Dummy implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::fixture::Dummy`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Dummy.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::fixture::Dummy`; readonly $typeArgs: []; readonly $isPhantom = Dummy.$isPhantom;
 ...
 static reified( ): DummyReified { const reifiedBcs = Dummy.bcs; return { typeName: Dummy.$typeName, fullTypeName: composeSuiType( Dummy.$typeName, ...[] ) as `${typeof PKG_V1}::fixture::Dummy`, typeArgs: [ ] as [], isPhantom: Dummy.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Dummy.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Dummy.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Dummy.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Dummy.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Dummy.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Dummy.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Dummy.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Dummy.fetch( client, id, ), new: ( fields: DummyFields, ) => { return new Dummy( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Dummy", {
 ...
 static get bcs(): ReturnType<typeof Dummy.instantiateBcs> { if (!Dummy.cachedBcs) { Dummy.cachedBcs = Dummy.instantiateBcs() } return Dummy.cachedBcs };
 ...
 static fromSuiObjectData( data: SuiObjectData ): Dummy { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isDummy(data.bcs.type)) { throw new Error(`object at is not a Dummy object`); }

 return Dummy.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Dummy.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export class WithGenericField<T extends TypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::fixture::WithGenericField`; static readonly $numTypeParams = 1; static readonly $isPhantom = [false,] as const;

 readonly $typeName = WithGenericField.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::fixture::WithGenericField<${ToTypeStr<T>}>`; readonly $typeArgs: [ToTypeStr<T>]; readonly $isPhantom = WithGenericField.$isPhantom;
 ...
 static reified<T extends Reified<TypeArgument, any>>( T: T ): WithGenericFieldReified<ToTypeArgument<T>> { const reifiedBcs = WithGenericField.bcs(toBcs(T)); return { typeName: WithGenericField.$typeName, fullTypeName: composeSuiType( WithGenericField.$typeName, ...[extractType(T)] ) as `${typeof PKG_V1}::fixture::WithGenericField<${ToTypeStr<ToTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [ToTypeStr<ToTypeArgument<T>>], isPhantom: WithGenericField.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => WithGenericField.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => WithGenericField.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => WithGenericField.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => WithGenericField.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => WithGenericField.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => WithGenericField.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => WithGenericField.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => WithGenericField.fetch( client, T, id, ), new: ( fields: WithGenericFieldFields<ToTypeArgument<T>>, ) => { return new WithGenericField( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return <T extends BcsType<any>>(T: T) => bcs.struct(`WithGenericField<${T.name}>`, {
 ...
 static get bcs(): ReturnType<typeof WithGenericField.instantiateBcs> { if (!WithGenericField.cachedBcs) { WithGenericField.cachedBcs = WithGenericField.instantiateBcs() } return WithGenericField.cachedBcs };
 ...
 static fromSuiObjectData<T extends Reified<TypeArgument, any>>( typeArg: T, data: SuiObjectData ): WithGenericField<ToTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isWithGenericField(data.bcs.type)) { throw new Error(`object at is not a WithGenericField object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

 return WithGenericField.fromBcs( typeArg, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return WithGenericField.fromSuiParsedData( typeArg, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export class Bar implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::fixture::Bar`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Bar.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::fixture::Bar`; readonly $typeArgs: []; readonly $isPhantom = Bar.$isPhantom;
 ...
 static reified( ): BarReified { const reifiedBcs = Bar.bcs; return { typeName: Bar.$typeName, fullTypeName: composeSuiType( Bar.$typeName, ...[] ) as `${typeof PKG_V1}::fixture::Bar`, typeArgs: [ ] as [], isPhantom: Bar.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Bar.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Bar.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Bar.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Bar.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Bar.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Bar.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Bar.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Bar.fetch( client, id, ), new: ( fields: BarFields, ) => { return new Bar( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Bar", {
 ...
 static get bcs(): ReturnType<typeof Bar.instantiateBcs> { if (!Bar.cachedBcs) { Bar.cachedBcs = Bar.instantiateBcs() } return Bar.cachedBcs };
 ...
 static fromSuiObjectData( data: SuiObjectData ): Bar { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBar(data.bcs.type)) { throw new Error(`object at is not a Bar object`); }

 return Bar.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Bar.fromSuiParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export class WithTwoGenerics<T extends TypeArgument, U extends TypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::fixture::WithTwoGenerics`; static readonly $numTypeParams = 2; static readonly $isPhantom = [false,false,] as const;

 readonly $typeName = WithTwoGenerics.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::fixture::WithTwoGenerics<${ToTypeStr<T>}, ${ToTypeStr<U>}>`; readonly $typeArgs: [ToTypeStr<T>, ToTypeStr<U>]; readonly $isPhantom = WithTwoGenerics.$isPhantom;
 ...
 static reified<T extends Reified<TypeArgument, any>, U extends Reified<TypeArgument, any>>( T: T, U: U ): WithTwoGenericsReified<ToTypeArgument<T>, ToTypeArgument<U>> { const reifiedBcs = WithTwoGenerics.bcs(toBcs(T), toBcs(U)); return { typeName: WithTwoGenerics.$typeName, fullTypeName: composeSuiType( WithTwoGenerics.$typeName, ...[extractType(T), extractType(U)] ) as `${typeof PKG_V1}::fixture::WithTwoGenerics<${ToTypeStr<ToTypeArgument<T>>}, ${ToTypeStr<ToTypeArgument<U>>}>`, typeArgs: [ extractType(T), extractType(U) ] as [ToTypeStr<ToTypeArgument<T>>, ToTypeStr<ToTypeArgument<U>>], isPhantom: WithTwoGenerics.$isPhantom, reifiedTypeArgs: [T, U], fromFields: (fields: Record<string, any>) => WithTwoGenerics.fromFields( [T, U], fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => WithTwoGenerics.fromFieldsWithTypes( [T, U], item, ), fromBcs: (data: Uint8Array) => WithTwoGenerics.fromFields( [T, U], reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => WithTwoGenerics.fromJSONField( [T, U], field, ), fromJSON: (json: Record<string, any>) => WithTwoGenerics.fromJSON( [T, U], json, ), fromSuiParsedData: (content: SuiParsedData) => WithTwoGenerics.fromSuiParsedData( [T, U], content, ), fromSuiObjectData: (content: SuiObjectData) => WithTwoGenerics.fromSuiObjectData( [T, U], content, ), fetch: async (client: SuiClient, id: string) => WithTwoGenerics.fetch( client, [T, U], id, ), new: ( fields: WithTwoGenericsFields<ToTypeArgument<T>, ToTypeArgument<U>>, ) => { return new WithTwoGenerics( [extractType(T), extractType(U)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return <T extends BcsType<any>, U extends BcsType<any>>(T: T, U: U) => bcs.struct(`WithTwoGenerics<${T.name}, ${U.name}>`, {
 ...
 static get bcs(): ReturnType<typeof WithTwoGenerics.instantiateBcs> { if (!WithTwoGenerics.cachedBcs) { WithTwoGenerics.cachedBcs = WithTwoGenerics.instantiateBcs() } return WithTwoGenerics.cachedBcs };
 ...
 static fromSuiObjectData<T extends Reified<TypeArgument, any>, U extends Reified<TypeArgument, any>>( typeArgs: [T, U], data: SuiObjectData ): WithTwoGenerics<ToTypeArgument<T>, ToTypeArgument<U>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isWithTwoGenerics(data.bcs.type)) { throw new Error(`object at is not a WithTwoGenerics object`); }
 ...
 return WithTwoGenerics.fromBcs( typeArgs, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return WithTwoGenerics.fromSuiParsedData( typeArgs, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export class Foo<T extends TypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::fixture::Foo`; static readonly $numTypeParams = 1; static readonly $isPhantom = [false,] as const;

 readonly $typeName = Foo.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::fixture::Foo<${ToTypeStr<T>}>`; readonly $typeArgs: [ToTypeStr<T>]; readonly $isPhantom = Foo.$isPhantom;
 ...
 static reified<T extends Reified<TypeArgument, any>>( T: T ): FooReified<ToTypeArgument<T>> { const reifiedBcs = Foo.bcs(toBcs(T)); return { typeName: Foo.$typeName, fullTypeName: composeSuiType( Foo.$typeName, ...[extractType(T)] ) as `${typeof PKG_V1}::fixture::Foo<${ToTypeStr<ToTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [ToTypeStr<ToTypeArgument<T>>], isPhantom: Foo.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => Foo.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Foo.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => Foo.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Foo.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => Foo.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => Foo.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => Foo.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => Foo.fetch( client, T, id, ), new: ( fields: FooFields<ToTypeArgument<T>>, ) => { return new Foo( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return <T extends BcsType<any>>(T: T) => bcs.struct(`Foo<${T.name}>`, {
 ...
 static get bcs(): ReturnType<typeof Foo.instantiateBcs> { if (!Foo.cachedBcs) { Foo.cachedBcs = Foo.instantiateBcs() } return Foo.cachedBcs };
 ...
 static fromSuiObjectData<T extends Reified<TypeArgument, any>>( typeArg: T, data: SuiObjectData ): Foo<ToTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isFoo(data.bcs.type)) { throw new Error(`object at is not a Foo object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

 return Foo.fromBcs( typeArg, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return Foo.fromSuiParsedData( typeArg, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export class WithSpecialTypes<T extends PhantomTypeArgument, U extends TypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::fixture::WithSpecialTypes`; static readonly $numTypeParams = 2; static readonly $isPhantom = [true,false,] as const;

 readonly $typeName = WithSpecialTypes.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::fixture::WithSpecialTypes<${PhantomToTypeStr<T>}, ${ToTypeStr<U>}>`; readonly $typeArgs: [PhantomToTypeStr<T>, ToTypeStr<U>]; readonly $isPhantom = WithSpecialTypes.$isPhantom;
 ...
 static reified<T extends PhantomReified<PhantomTypeArgument>, U extends Reified<TypeArgument, any>>( T: T, U: U ): WithSpecialTypesReified<ToPhantomTypeArgument<T>, ToTypeArgument<U>> { const reifiedBcs = WithSpecialTypes.bcs(toBcs(U)); return { typeName: WithSpecialTypes.$typeName, fullTypeName: composeSuiType( WithSpecialTypes.$typeName, ...[extractType(T), extractType(U)] ) as `${typeof PKG_V1}::fixture::WithSpecialTypes<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}, ${ToTypeStr<ToTypeArgument<U>>}>`, typeArgs: [ extractType(T), extractType(U) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>, ToTypeStr<ToTypeArgument<U>>], isPhantom: WithSpecialTypes.$isPhantom, reifiedTypeArgs: [T, U], fromFields: (fields: Record<string, any>) => WithSpecialTypes.fromFields( [T, U], fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => WithSpecialTypes.fromFieldsWithTypes( [T, U], item, ), fromBcs: (data: Uint8Array) => WithSpecialTypes.fromFields( [T, U], reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => WithSpecialTypes.fromJSONField( [T, U], field, ), fromJSON: (json: Record<string, any>) => WithSpecialTypes.fromJSON( [T, U], json, ), fromSuiParsedData: (content: SuiParsedData) => WithSpecialTypes.fromSuiParsedData( [T, U], content, ), fromSuiObjectData: (content: SuiObjectData) => WithSpecialTypes.fromSuiObjectData( [T, U], content, ), fetch: async (client: SuiClient, id: string) => WithSpecialTypes.fetch( client, [T, U], id, ), new: ( fields: WithSpecialTypesFields<ToPhantomTypeArgument<T>, ToTypeArgument<U>>, ) => { return new WithSpecialTypes( [extractType(T), extractType(U)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return <U extends BcsType<any>>(U: U) => bcs.struct(`WithSpecialTypes<${U.name}>`, {
 ...
 static get bcs(): ReturnType<typeof WithSpecialTypes.instantiateBcs> { if (!WithSpecialTypes.cachedBcs) { WithSpecialTypes.cachedBcs = WithSpecialTypes.instantiateBcs() } return WithSpecialTypes.cachedBcs };
 ...
 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>, U extends Reified<TypeArgument, any>>( typeArgs: [T, U], data: SuiObjectData ): WithSpecialTypes<ToPhantomTypeArgument<T>, ToTypeArgument<U>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isWithSpecialTypes(data.bcs.type)) { throw new Error(`object at is not a WithSpecialTypes object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 2) { throw new Error(`type argument mismatch: expected 2 type arguments but got ${gotTypeArgs.length}`); }; for (let i = 0; i < 2; i++) { const gotTypeArg = compressSuiType(gotTypeArgs[i]); const expectedTypeArg = compressSuiType(extractType(typeArgs[i])); if (gotTypeArg !== expectedTypeArg) { throw new Error(`type argument mismatch at position ${i}: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); } };

 return WithSpecialTypes.fromBcs( typeArgs, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return WithSpecialTypes.fromSuiParsedData( typeArgs, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export class WithSpecialTypesAsGenerics<T0 extends TypeArgument, T1 extends TypeArgument, T2 extends TypeArgument, T3 extends TypeArgument, T4 extends TypeArgument, T5 extends TypeArgument, T6 extends TypeArgument, T7 extends TypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::fixture::WithSpecialTypesAsGenerics`; static readonly $numTypeParams = 8; static readonly $isPhantom = [false,false,false,false,false,false,false,false,] as const;

 readonly $typeName = WithSpecialTypesAsGenerics.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::fixture::WithSpecialTypesAsGenerics<${ToTypeStr<T0>}, ${ToTypeStr<T1>}, ${ToTypeStr<T2>}, ${ToTypeStr<T3>}, ${ToTypeStr<T4>}, ${ToTypeStr<T5>}, ${ToTypeStr<T6>}, ${ToTypeStr<T7>}>`; readonly $typeArgs: [ToTypeStr<T0>, ToTypeStr<T1>, ToTypeStr<T2>, ToTypeStr<T3>, ToTypeStr<T4>, ToTypeStr<T5>, ToTypeStr<T6>, ToTypeStr<T7>]; readonly $isPhantom = WithSpecialTypesAsGenerics.$isPhantom;
 ...
 static reified<T0 extends Reified<TypeArgument, any>, T1 extends Reified<TypeArgument, any>, T2 extends Reified<TypeArgument, any>, T3 extends Reified<TypeArgument, any>, T4 extends Reified<TypeArgument, any>, T5 extends Reified<TypeArgument, any>, T6 extends Reified<TypeArgument, any>, T7 extends Reified<TypeArgument, any>>( T0: T0, T1: T1, T2: T2, T3: T3, T4: T4, T5: T5, T6: T6, T7: T7 ): WithSpecialTypesAsGenericsReified<ToTypeArgument<T0>, ToTypeArgument<T1>, ToTypeArgument<T2>, ToTypeArgument<T3>, ToTypeArgument<T4>, ToTypeArgument<T5>, ToTypeArgument<T6>, ToTypeArgument<T7>> { const reifiedBcs = WithSpecialTypesAsGenerics.bcs(toBcs(T0), toBcs(T1), toBcs(T2), toBcs(T3), toBcs(T4), toBcs(T5), toBcs(T6), toBcs(T7)); return { typeName: WithSpecialTypesAsGenerics.$typeName, fullTypeName: composeSuiType( WithSpecialTypesAsGenerics.$typeName, ...[extractType(T0), extractType(T1), extractType(T2), extractType(T3), extractType(T4), extractType(T5), extractType(T6), extractType(T7)] ) as `${typeof PKG_V1}::fixture::WithSpecialTypesAsGenerics<${ToTypeStr<ToTypeArgument<T0>>}, ${ToTypeStr<ToTypeArgument<T1>>}, ${ToTypeStr<ToTypeArgument<T2>>}, ${ToTypeStr<ToTypeArgument<T3>>}, ${ToTypeStr<ToTypeArgument<T4>>}, ${ToTypeStr<ToTypeArgument<T5>>}, ${ToTypeStr<ToTypeArgument<T6>>}, ${ToTypeStr<ToTypeArgument<T7>>}>`, typeArgs: [ extractType(T0), extractType(T1), extractType(T2), extractType(T3), extractType(T4), extractType(T5), extractType(T6), extractType(T7) ] as [ToTypeStr<ToTypeArgument<T0>>, ToTypeStr<ToTypeArgument<T1>>, ToTypeStr<ToTypeArgument<T2>>, ToTypeStr<ToTypeArgument<T3>>, ToTypeStr<ToTypeArgument<T4>>, ToTypeStr<ToTypeArgument<T5>>, ToTypeStr<ToTypeArgument<T6>>, ToTypeStr<ToTypeArgument<T7>>], isPhantom: WithSpecialTypesAsGenerics.$isPhantom, reifiedTypeArgs: [T0, T1, T2, T3, T4, T5, T6, T7], fromFields: (fields: Record<string, any>) => WithSpecialTypesAsGenerics.fromFields( [T0, T1, T2, T3, T4, T5, T6, T7], fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => WithSpecialTypesAsGenerics.fromFieldsWithTypes( [T0, T1, T2, T3, T4, T5, T6, T7], item, ), fromBcs: (data: Uint8Array) => WithSpecialTypesAsGenerics.fromFields( [T0, T1, T2, T3, T4, T5, T6, T7], reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => WithSpecialTypesAsGenerics.fromJSONField( [T0, T1, T2, T3, T4, T5, T6, T7], field, ), fromJSON: (json: Record<string, any>) => WithSpecialTypesAsGenerics.fromJSON( [T0, T1, T2, T3, T4, T5, T6, T7], json, ), fromSuiParsedData: (content: SuiParsedData) => WithSpecialTypesAsGenerics.fromSuiParsedData( [T0, T1, T2, T3, T4, T5, T6, T7], content, ), fromSuiObjectData: (content: SuiObjectData) => WithSpecialTypesAsGenerics.fromSuiObjectData( [T0, T1, T2, T3, T4, T5, T6, T7], content, ), fetch: async (client: SuiClient, id: string) => WithSpecialTypesAsGenerics.fetch( client, [T0, T1, T2, T3, T4, T5, T6, T7], id, ), new: ( fields: WithSpecialTypesAsGenericsFields<ToTypeArgument<T0>, ToTypeArgument<T1>, ToTypeArgument<T2>, ToTypeArgument<T3>, ToTypeArgument<T4>, ToTypeArgument<T5>, ToTypeArgument<T6>, ToTypeArgument<T7>>, ) => { return new WithSpecialTypesAsGenerics( [extractType(T0), extractType(T1), extractType(T2), extractType(T3), extractType(T4), extractType(T5), extractType(T6), extractType(T7)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return <T0 extends BcsType<any>, T1 extends BcsType<any>, T2 extends BcsType<any>, T3 extends BcsType<any>, T4 extends BcsType<any>, T5 extends BcsType<any>, T6 extends BcsType<any>, T7 extends BcsType<any>>(T0: T0, T1: T1, T2: T2, T3: T3, T4: T4, T5: T5, T6: T6, T7: T7) => bcs.struct(`WithSpecialTypesAsGenerics<${T0.name}, ${T1.name}, ${T2.name}, ${T3.name}, ${T4.name}, ${T5.name}, ${T6.name}, ${T7.name}>`, {

 id: UID.bcs, string: T0, ascii_string: T1, url: T2, id_field: T3, uid: T4, balance: T5, option: T6, option_none: T7

}) };

 private static cachedBcs: ReturnType<typeof WithSpecialTypesAsGenerics.instantiateBcs> | null = null;

 static get bcs(): ReturnType<typeof WithSpecialTypesAsGenerics.instantiateBcs> { if (!WithSpecialTypesAsGenerics.cachedBcs) { WithSpecialTypesAsGenerics.cachedBcs = WithSpecialTypesAsGenerics.instantiateBcs() } return WithSpecialTypesAsGenerics.cachedBcs };
 ...
 static fromSuiObjectData<T0 extends Reified<TypeArgument, any>, T1 extends Reified<TypeArgument, any>, T2 extends Reified<TypeArgument, any>, T3 extends Reified<TypeArgument, any>, T4 extends Reified<TypeArgument, any>, T5 extends Reified<TypeArgument, any>, T6 extends Reified<TypeArgument, any>, T7 extends Reified<TypeArgument, any>>( typeArgs: [T0, T1, T2, T3, T4, T5, T6, T7], data: SuiObjectData ): WithSpecialTypesAsGenerics<ToTypeArgument<T0>, ToTypeArgument<T1>, ToTypeArgument<T2>, ToTypeArgument<T3>, ToTypeArgument<T4>, ToTypeArgument<T5>, ToTypeArgument<T6>, ToTypeArgument<T7>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isWithSpecialTypesAsGenerics(data.bcs.type)) { throw new Error(`object at is not a WithSpecialTypesAsGenerics object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 8) { throw new Error(`type argument mismatch: expected 8 type arguments but got ${gotTypeArgs.length}`); }; for (let i = 0; i < 8; i++) { const gotTypeArg = compressSuiType(gotTypeArgs[i]); const expectedTypeArg = compressSuiType(extractType(typeArgs[i])); if (gotTypeArg !== expectedTypeArg) { throw new Error(`type argument mismatch at position ${i}: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); } };

 return WithSpecialTypesAsGenerics.fromBcs( typeArgs, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return WithSpecialTypesAsGenerics.fromSuiParsedData( typeArgs, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
...
export class WithSpecialTypesInVectors<T extends TypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::fixture::WithSpecialTypesInVectors`; static readonly $numTypeParams = 1; static readonly $isPhantom = [false,] as const;

 readonly $typeName = WithSpecialTypesInVectors.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::fixture::WithSpecialTypesInVectors<${ToTypeStr<T>}>`; readonly $typeArgs: [ToTypeStr<T>]; readonly $isPhantom = WithSpecialTypesInVectors.$isPhantom;
 ...
 static reified<T extends Reified<TypeArgument, any>>( T: T ): WithSpecialTypesInVectorsReified<ToTypeArgument<T>> { const reifiedBcs = WithSpecialTypesInVectors.bcs(toBcs(T)); return { typeName: WithSpecialTypesInVectors.$typeName, fullTypeName: composeSuiType( WithSpecialTypesInVectors.$typeName, ...[extractType(T)] ) as `${typeof PKG_V1}::fixture::WithSpecialTypesInVectors<${ToTypeStr<ToTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [ToTypeStr<ToTypeArgument<T>>], isPhantom: WithSpecialTypesInVectors.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => WithSpecialTypesInVectors.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => WithSpecialTypesInVectors.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => WithSpecialTypesInVectors.fromFields( T, reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => WithSpecialTypesInVectors.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => WithSpecialTypesInVectors.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => WithSpecialTypesInVectors.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => WithSpecialTypesInVectors.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => WithSpecialTypesInVectors.fetch( client, T, id, ), new: ( fields: WithSpecialTypesInVectorsFields<ToTypeArgument<T>>, ) => { return new WithSpecialTypesInVectors( [extractType(T)], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return <T extends BcsType<any>>(T: T) => bcs.struct(`WithSpecialTypesInVectors<${T.name}>`, {
 ...
 static get bcs(): ReturnType<typeof WithSpecialTypesInVectors.instantiateBcs> { if (!WithSpecialTypesInVectors.cachedBcs) { WithSpecialTypesInVectors.cachedBcs = WithSpecialTypesInVectors.instantiateBcs() } return WithSpecialTypesInVectors.cachedBcs };
 ...
 static fromSuiObjectData<T extends Reified<TypeArgument, any>>( typeArg: T, data: SuiObjectData ): WithSpecialTypesInVectors<ToTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isWithSpecialTypesInVectors(data.bcs.type)) { throw new Error(`object at is not a WithSpecialTypesInVectors object`); }

 const gotTypeArgs = parseTypeName(data.bcs.type).typeArgs; if (gotTypeArgs.length !== 1) { throw new Error(`type argument mismatch: expected 1 type argument but got '${gotTypeArgs.length}'`); }; const gotTypeArg = compressSuiType(gotTypeArgs[0]); const expectedTypeArg = compressSuiType(extractType(typeArg)); if (gotTypeArg !== compressSuiType(extractType(typeArg))) { throw new Error(`type argument mismatch: expected '${expectedTypeArg}' but got '${gotTypeArg}'`); };

 return WithSpecialTypesInVectors.fromBcs( typeArg, fromB64(data.bcs.bcsBytes) ); } if (data.content) { return WithSpecialTypesInVectors.fromSuiParsedData( typeArg, data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }
