...
export function isUQ32_32(type: string): boolean { type = compressSuiType(type); return type === `0x1::uq32_32::UQ32_32`; }
...
export class UQ32_32 implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x1::uq32_32::UQ32_32`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UQ32_32.$typeName; readonly $fullTypeName: `0x1::uq32_32::UQ32_32`; readonly $typeArgs: []; readonly $isPhantom = UQ32_32.$isPhantom;

 readonly pos0: ToField<"u64">

 private constructor(typeArgs: [], fields: UQ32_32Fields, ) { this.$fullTypeName = composeSuiType( UQ32_32.$typeName, ...typeArgs ) as `0x1::uq32_32::UQ32_32`; this.$typeArgs = typeArgs;

 this.pos0 = fields.pos0; }

 static reified( ): UQ32_32Reified { const reifiedBcs = UQ32_32.bcs; return { typeName: UQ32_32.$typeName, fullTypeName: composeSuiType( UQ32_32.$typeName, ...[] ) as `0x1::uq32_32::UQ32_32`, typeArgs: [ ] as [], isPhantom: UQ32_32.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UQ32_32.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UQ32_32.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UQ32_32.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => UQ32_32.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UQ32_32.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UQ32_32.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UQ32_32.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UQ32_32.fetch( client, id, ), new: ( fields: UQ32_32Fields, ) => { return new UQ32_32( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("UQ32_32", {
 ...
 static get bcs(): ReturnType<typeof UQ32_32.instantiateBcs> { if (!UQ32_32.cachedBcs) { UQ32_32.cachedBcs = UQ32_32.instantiateBcs() } return UQ32_32.cachedBcs };
