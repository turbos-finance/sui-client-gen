...
export class String implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x1::string::String`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = String.$typeName; readonly $fullTypeName: `0x1::string::String`; readonly $typeArgs: []; readonly $isPhantom = String.$isPhantom;
