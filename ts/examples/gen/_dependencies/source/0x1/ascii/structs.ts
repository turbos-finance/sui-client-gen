...
export class String implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x1::ascii::String`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = String.$typeName; readonly $fullTypeName: `0x1::ascii::String`; readonly $typeArgs: []; readonly $isPhantom = String.$isPhantom;
 ...
 static reified( ): StringReified { const reifiedBcs = String.bcs; return { typeName: String.$typeName, fullTypeName: composeSuiType( String.$typeName, ...[] ) as `0x1::ascii::String`, typeArgs: [ ] as [], isPhantom: String.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => String.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => String.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => String.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => String.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => String.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => String.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => String.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => String.fetch( client, id, ), new: ( fields: StringFields, ) => { return new String( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("String", {
 ...
 static get bcs(): ReturnType<typeof String.instantiateBcs> { if (!String.cachedBcs) { String.cachedBcs = String.instantiateBcs() } return String.cachedBcs };
...
export class Char implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x1::ascii::Char`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Char.$typeName; readonly $fullTypeName: `0x1::ascii::Char`; readonly $typeArgs: []; readonly $isPhantom = Char.$isPhantom;
 ...
 static reified( ): CharReified { const reifiedBcs = Char.bcs; return { typeName: Char.$typeName, fullTypeName: composeSuiType( Char.$typeName, ...[] ) as `0x1::ascii::Char`, typeArgs: [ ] as [], isPhantom: Char.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Char.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Char.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Char.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => Char.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Char.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Char.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => Char.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => Char.fetch( client, id, ), new: ( fields: CharFields, ) => { return new Char( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("Char", {
 ...
 static get bcs(): ReturnType<typeof Char.instantiateBcs> { if (!Char.cachedBcs) { Char.cachedBcs = Char.instantiateBcs() } return Char.cachedBcs };
