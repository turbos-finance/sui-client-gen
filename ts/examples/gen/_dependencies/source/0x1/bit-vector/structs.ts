...
export class BitVector implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `0x1::bit_vector::BitVector`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = BitVector.$typeName; readonly $fullTypeName: `0x1::bit_vector::BitVector`; readonly $typeArgs: []; readonly $isPhantom = BitVector.$isPhantom;
 ...
 static reified( ): BitVectorReified { const reifiedBcs = BitVector.bcs; return { typeName: BitVector.$typeName, fullTypeName: composeSuiType( BitVector.$typeName, ...[] ) as `0x1::bit_vector::BitVector`, typeArgs: [ ] as [], isPhantom: BitVector.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => BitVector.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => BitVector.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => BitVector.fromFields( reifiedBcs.parse(data) ), bcs: reifiedBcs, fromJSONField: (field: any) => BitVector.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => BitVector.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => BitVector.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => BitVector.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => BitVector.fetch( client, id, ), new: ( fields: BitVectorFields, ) => { return new BitVector( [], fields ) }, kind: "StructClassReified", } }
 ...
 private static instantiateBcs() { return bcs.struct("BitVector", {
 ...
 static get bcs(): ReturnType<typeof BitVector.instantiateBcs> { if (!BitVector.cachedBcs) { BitVector.cachedBcs = BitVector.instantiateBcs() } return BitVector.cachedBcs };
